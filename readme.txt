...
QCAD works on Windows, Mac OS X and many Linux and Unix Systems. The source code of QCAD is distributed under the GPLv3 (see LICENSE.txt for details).
