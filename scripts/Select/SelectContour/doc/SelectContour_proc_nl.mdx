...
2. Gebruik de muis om één object te kiezen van de contour die u wilt
   ...
   verbonden zijn. Alle aangesloten objecten worden geselecteerd of
   gedeselecteerd, afhankelijk van de gekozen selectiemodus.

In plaats van deze functie te gebruiken, kunt u ook dubbelklikken op het
object om deze en alle verbonden objecten te selecteren.
