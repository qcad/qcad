 ...
 */
function SnapSelection(guiAction) {
    Snap.call(this, guiAction);
}

SnapSelection.prototype = new Snap();

SnapSelection.prototype.beginEvent = function() {
    Snap.prototype.beginEvent.call(this);
    this.getDocumentInterface().setSnap(new RSnapSelection());
    this.terminate();
