 ...
 */
function ExDrawBoundingBox(guiAction) {
...
ExDrawBoundingBox.prototype = new DrawExamples();

/**
 * Draws the bounding box(es) of the selected entities and terminates.
 */
ExDrawBoundingBox.prototype.beginEvent = function() {
 ...
 */
ExDrawBoundingBox.init = function(basePath) {
    var action = new RGuiAction("Draw &Bounding Box", RMainWindowQt.getMainWindow());
    action.setRequiresDocument(true);
    action.setScriptFile(basePath + "/ExDrawBoundingBox.js");
