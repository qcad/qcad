...
ShowToolDialog.init = function(basePath) {
    ...
    ShowToolDialog.shortcutReturn = new QShortcut(new QKeySequence(Qt.Key_Return.valueOf()), appWin, 0, 0, Qt.WindowShortcut);
    ...
    ShowToolDialog.shortcutEnter = new QShortcut(new QKeySequence(Qt.Key_Enter.valueOf()), appWin, 0, 0, Qt.WindowShortcut);
