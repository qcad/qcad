/**
 * Copyright (c) 2017 by Christian Aigner, inspired by Matthias Melcher's LineDove2 script. All rights reserved.
 * 
 * This file is an extension of the QCAD project.
 *
 * LineDove2 is free software: you can redistribute it and/or modify
...
function LineDove2(guiAction) {
    ...
    this.setUiOptions("LineDove2.ui");
}

LineDove2.prototype = new EAction();
...
LineDove2.prototype.beginEvent = function() {
  EAction.prototype.beginEvent.call(this);
  
  this.setState(LineDove2.State.SettingCorner1);
};

LineDove2.prototype.setState = function(state) {
  ...
  switch (this.state) {
    case LineDove2.State.SettingCorner1:
    ...
    case LineDove2.State.SettingCorner2:
...
LineDove2.prototype.escapeEvent = function() {
  switch (this.state) {
    case LineDove2.State.SettingCorner1:
...
LineDove2.prototype.pickCoordinate = function(event, preview) {
  ...
  switch (this.state) {
    case LineDove2.State.SettingCorner1:
      ...
      if (!preview) {
        ...
        //di.repaintViews();
        this.setState(LineDove2.State.SettingCorner2);
      }
      break;
...
LineDove2.prototype.getOperation = function(preview) {
...
LineDove2.prototype.slotDovetailNumberChanged = function(value) {
  this.dovetailNumber = value;
  this.updatePreview(true);
};

LineDove2.prototype.slotDovetailHeightChanged = function(value) {
  this.dovetailHeight = value;
  this.updatePreview(true);
};

LineDove2.prototype.slotDovetailGradientChanged = function(value) {
  this.dovetailGradient = value;
  this.updatePreview(true);
};

LineDove2.prototype.slotPinRatioChanged = function(value) {
  this.pinRatio = value;
  this.updatePreview(true);
};
