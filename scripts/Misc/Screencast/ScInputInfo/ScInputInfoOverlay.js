...
function ExScreencastOverlay(parentWidget) {
    ...
    this.objectName = "ExScreencastOverlay";
    ...
    var flags = new Qt.WindowFlags(Qt.Window | Qt.WindowStaysOnTopHint | Qt.FramelessWindowHint);
    //var flags = new Qt.WindowFlags(Qt.WindowStaysOnTopHint);
    //this.setWindowFlags(Qt.Window);
    this.setWindowFlags(flags);
    // this.setAttribute(Qt.WA_NoMousePropagation);
    this.focusPolicy = Qt.NoFocus;
    this.color = new QColor(128, 128, 255, 200);
    //this.opacity = 0.2;
    ...
    //var bitmap = new QBitmap(ExScreencastOverlay.includeBasePath + "/CrosshairCursor.png", "PNG");
    //var mask = new QBitmap(ExScreencastOverlay.includeBasePath + "/CrosshairCursorMask.png", "PNG");
    //this.cursor = new QCursor(bitmap, mask, 15, 15);
...
ExScreencastOverlay.prototype.paintEvent = function(evt) {
    ...
    var f = undefined;
    switch (this.buttons) {
        case Qt.LeftButton.valueOf():
            f = "mouse_l.svg";
            break;
        case Qt.MidButton.valueOf():
            f = "mouse_m.svg";
            break;
        case Qt.RightButton.valueOf():
            f = "mouse_r.svg";
            break;
    }
...
ExScreencastOverlay.prototype.eventFilter = function(watched, e) {
    ...
    if (watched.objectName==="ExScreencastOverlay") {
        return false;
    }
