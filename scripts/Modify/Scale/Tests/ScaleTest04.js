...
// File        : scripts/Modify/Scale/Tests/ScaleTest04.js
...
ScaleTest04.prototype = new TdbTest();
...
ScaleTest04.prototype.test00 = function() {
    ...
    var p = new RVector(20.0, 15.997);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.triggerCommand('scale');
    this.setZoom(4.910179640718563, new RVector(0.0256098, -7.71341, 0) );
    var p = new RVector(90.195122, 90.39878);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.dlgStart();
    ...
    this.dlgEnd();
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('ScaleTest04_000.dxf');
    this.tearDown();
    qDebug('finished ScaleTest04.test00()');
};
