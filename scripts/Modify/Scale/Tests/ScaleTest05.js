...
// File        : scripts/Modify/Scale/Tests/ScaleTest05.js
...
ScaleTest05.prototype = new TdbTest();

ScaleTest05.prototype.test00 = function() {
    qDebug('running ScaleTest05.test00()...');
    this.setUp();
    ...
    this.importFile('scripts/Modify/Scale/Tests/data/polyline.dxf');
    this.setZoom(4.910179640718563, new RVector(0.0256098, -7.71341, 0) );
    var p = new RVector(17.081707, 16.063415);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.triggerCommand('scale');
    this.setZoom(4.910179640718563, new RVector(0.0256098, -7.71341, 0) );
    var p = new RVector(91.009756, 89.176829);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.dlgStart();
    ...
    this.dlgEnd();
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('ScaleTest05_000.dxf');
    this.tearDown();
    qDebug('finished ScaleTest05.test00()');
};
