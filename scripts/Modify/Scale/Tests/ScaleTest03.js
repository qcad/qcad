...
// File        : scripts/Modify/Scale/Tests/ScaleTest03.js
...
ScaleTest03.prototype = new TdbTest();

ScaleTest03.prototype.test00 = function() {
    qDebug('running ScaleTest03.test00()...');
    this.setUp();
    var w = objectFromPath('MainWindow::CadToolBar::MainToolsPanel');
    this.sendMouseEvent(w, QEvent.MouseButtonPress, new QPoint(48, 441), Qt.LeftButton, 1, 0);
    var w = objectFromPath('MainWindow::CadToolBar::MainToolsPanel');
    this.sendMouseEvent(w, QEvent.MouseButtonRelease, new QPoint(48, 441), Qt.LeftButton, 0, 0);
    this.importFile('scripts/Modify/Scale/Tests/data/points.dxf');
    this.setZoom(4.910179640718563, new RVector(0.0256098, -7.71341, 0) );
    var p = new RVector(19.321951, 15.045122);
    ...
    this.dlgEnd();
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('ScaleTest03_000.dxf');
    this.tearDown();
    qDebug('finished ScaleTest03.test00()');
};
