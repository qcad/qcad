...
ReverseTest01.prototype.test00 = function() {
    ...
    this.selectAll();
    var w = objectFromPath('MainWindow::CadQToolBar::CadToolBar::PolylineToolsPanel');
    ...
    var w = objectFromPath('MainWindow::CadQToolBar::CadToolBar::ModifyToolsPanel');
    ...
    TdbTest.clickOnWidget('MainWindow::CadQToolBar::CadToolBar::ModifyToolsPanel::BackButton');
