...
TranslateRotateTest01.prototype.test00 = function() {
    ...
    this.sendMouseEvent(w, QEvent.MouseButtonPress, new QPoint(41, 415), Qt.LeftButton, 1, 0);
    var w = objectFromPath('MainWindow::CadToolsDock::CadToolBar::MainToolsPanel');
    this.sendMouseEvent(w, QEvent.MouseButtonRelease, new QPoint(41, 415), Qt.LeftButton, 0, 0);
    ...
    var p = new RVector(8.783951, 6.093502);
