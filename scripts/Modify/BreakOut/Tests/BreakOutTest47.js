...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest47.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/line, click entity 1 region 2

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest47() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest47.js');
}

BreakOutTest47.prototype = new TdbTest();

BreakOutTest47.prototype.test00 = function() {
    qDebug('running BreakOutTest47.test00()...');
    this.setUp();
    ...
    var p = new RVector(27.900617248673218, 10);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest47_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest47.test00()');
};
