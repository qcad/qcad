...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest82.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/arc3p, click entity 1 region 1

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest82() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest82.js');
}

BreakOutTest82.prototype = new TdbTest();

BreakOutTest82.prototype.test00 = function() {
    qDebug('running BreakOutTest82.test00()...');
    this.setUp();
    ...
    var p = new RVector(25.00000000000001, 18.660254037844368);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest82_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest82.test00()');
};
