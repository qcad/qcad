...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest20.js
// Timestamp   : 2026-06-19
// Description : 

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest20() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest20.js');
}

BreakOutTest20.prototype = new TdbTest();

BreakOutTest20.prototype.test00 = function() {
    qDebug('running BreakOutTest20.test00()...');
    this.setUp();
    ...
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest20_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest20.test00()');
};
