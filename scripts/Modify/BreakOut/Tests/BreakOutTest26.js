...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest26.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/line, click entity 0 region 2

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest26() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest26.js');
}

BreakOutTest26.prototype = new TdbTest();

BreakOutTest26.prototype.test00 = function() {
    qDebug('running BreakOutTest26.test00()...');
    this.setUp();
    ...
    var p = new RVector(4.303138817699891, 7.452527828149712);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest26_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest26.test00()');
};
