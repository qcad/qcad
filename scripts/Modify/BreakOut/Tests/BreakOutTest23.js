...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest23.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/line, click entity 0 region 2

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest23() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest23.js');
}

BreakOutTest23.prototype = new TdbTest();

BreakOutTest23.prototype.test00 = function() {
    qDebug('running BreakOutTest23.test00()...');
    this.setUp();
    ...
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest23_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest23.test00()');
};
