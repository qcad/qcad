...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest46.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/line, click entity 1 region 1

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest46() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest46.js');
}

BreakOutTest46.prototype = new TdbTest();

BreakOutTest46.prototype.test00 = function() {
    qDebug('running BreakOutTest46.test00()...');
    this.setUp();
    ...
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest46_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest46.test00()');
};
