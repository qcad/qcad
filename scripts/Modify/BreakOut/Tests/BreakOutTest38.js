...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest38.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/line, click entity 0 region 1

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest38() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest38.js');
}

BreakOutTest38.prototype = new TdbTest();

BreakOutTest38.prototype.test00 = function() {
    qDebug('running BreakOutTest38.test00()...');
    this.setUp();
    ...
    var p = new RVector(-5.000000000000002, 10.000000000000002);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest38_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest38.test00()');
};
