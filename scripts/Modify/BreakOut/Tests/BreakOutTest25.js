...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest25.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/line, click entity 0 region 1

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest25() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest25.js');
}

BreakOutTest25.prototype = new TdbTest();

BreakOutTest25.prototype.test00 = function() {
    qDebug('running BreakOutTest25.test00()...');
    this.setUp();
    ...
    var p = new RVector(14.999999999999996, 19.999999999999993);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest25_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest25.test00()');
};
