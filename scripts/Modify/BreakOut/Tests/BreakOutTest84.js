...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest84.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/arc3p, click entity 0 region 1

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest84() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest84.js');
}

BreakOutTest84.prototype = new TdbTest();

BreakOutTest84.prototype.test00 = function() {
    qDebug('running BreakOutTest84.test00()...');
    this.setUp();
    ...
    var p = new RVector(5.000000000000009, 18.66025403784439);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest84_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest84.test00()');
};
