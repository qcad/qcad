...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest22.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/line, click entity 0 region 1

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest22() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest22.js');
}

BreakOutTest22.prototype = new TdbTest();

BreakOutTest22.prototype.test00 = function() {
    qDebug('running BreakOutTest22.test00()...');
    this.setUp();
    ...
    var p = new RVector(15.000000000000004, 20.000000000000007);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest22_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest22.test00()');
};
