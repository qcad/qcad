...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest48.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/line, click entity 1 region 1

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest48() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest48.js');
}

BreakOutTest48.prototype = new TdbTest();

BreakOutTest48.prototype.test00 = function() {
    qDebug('running BreakOutTest48.test00()...');
    this.setUp();
    ...
    var p = new RVector(9.99999999999999, 16);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest48_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest48.test00()');
};
