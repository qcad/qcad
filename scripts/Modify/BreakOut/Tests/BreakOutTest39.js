...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest39.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/line, click entity 0 region 2

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest39() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest39.js');
}

BreakOutTest39.prototype = new TdbTest();

BreakOutTest39.prototype.test00 = function() {
    qDebug('running BreakOutTest39.test00()...');
    this.setUp();
    ...
    var p = new RVector(4.892997585308225, 20.792445496369076);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest39_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest39.test00()');
};
