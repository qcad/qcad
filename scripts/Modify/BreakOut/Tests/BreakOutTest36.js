...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest36.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/line, click entity 0 region 2

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest36() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest36.js');
}

BreakOutTest36.prototype = new TdbTest();

BreakOutTest36.prototype.test00 = function() {
    qDebug('running BreakOutTest36.test00()...');
    this.setUp();
    ...
    var p = new RVector(25.792445496369076, 9.892997585308224);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest36_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest36.test00()');
};
