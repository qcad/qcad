...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest24.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/line, click entity 0 region 0

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest24() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest24.js');
}

BreakOutTest24.prototype = new TdbTest();

BreakOutTest24.prototype.test00 = function() {
    qDebug('running BreakOutTest24.test00()...');
    this.setUp();
    ...
    var p = new RVector(25.696861182300097, 7.452527828149716);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest24_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest24.test00()');
};
