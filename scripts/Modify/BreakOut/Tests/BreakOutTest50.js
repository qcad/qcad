...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest50.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/line, click entity 1 region 1

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest50() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest50.js');
}

BreakOutTest50.prototype = new TdbTest();

BreakOutTest50.prototype.test00 = function() {
    qDebug('running BreakOutTest50.test00()...');
    this.setUp();
    ...
    var p = new RVector(15, 9.999999999999998);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest50_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest50.test00()');
};
