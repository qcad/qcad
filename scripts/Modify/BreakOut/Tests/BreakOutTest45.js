...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest45.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/line, click entity 1 region 0

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest45() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest45.js');
}

BreakOutTest45.prototype = new TdbTest();

BreakOutTest45.prototype.test00 = function() {
    qDebug('running BreakOutTest45.test00()...');
    this.setUp();
    ...
    var p = new RVector(2.0993827513267824, 10);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest45_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest45.test00()');
};
