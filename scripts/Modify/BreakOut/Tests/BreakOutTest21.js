...
// File        : scripts/Modify/BreakOut/Tests/BreakOutTest21.js
// Timestamp   : 2026-08-25
// Description : BreakOutPro on arc3p/line, click entity 0 region 0

include('scripts/Developer/TestingDashboard/TdbTest.js');

function BreakOutTest21() {
    TdbTest.call(this, 'scripts/Modify/BreakOut/Tests/BreakOutTest21.js');
}

BreakOutTest21.prototype = new TdbTest();

BreakOutTest21.prototype.test00 = function() {
    qDebug('running BreakOutTest21.test00()...');
    this.setUp();
    ...
    var p = new RVector(4.303138817699894, 7.452527828149707);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('BreakOutTest21_000.dxf');
    this.tearDown();
    qDebug('finished BreakOutTest21.test00()');
};
