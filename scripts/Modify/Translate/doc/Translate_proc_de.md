1. Selektieren Sie die Objekte, die verschoben oder kopiert werden
 sollen.
2. Starten Sie dieses Werkzeug.
3. Bestimmen Sie den Bezugspunkt mit der Maus oder indem Sie eine Koordinate
 in die Kommandozeile eingeben.
4. Bestimmen Sie den Zielpunkt. Um die ausgewählten Objekte um 50 Einheiten
 nach rechts zu verschieben, geben Sie die relative Koordinate
 @50,0 in der Kommandozeile ein.
5. Der Dialog mit den Optionen zum Verschieben / Kopieren von Objekten wird
 angezeigt.  
Um die selektierten Objekte zu verschieben ohne die originalen Objekte
 ...
 "Original beibehalten". Außerdem können Sie mehrere Kopien auf einmal
...
Die neuen Objekte werden auf denselben Layer plaziert wie die Originale
 ...
 Layer / Attribute".
6. Klicken Sie "OK" um die Objekte zu verschieben / kopieren.
