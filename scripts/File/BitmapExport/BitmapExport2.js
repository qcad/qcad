...
BitmapExport.prototype.getProperties = function() {
    ...
    ret["width"] = Math.round(widthEdit.getValue());
    ret["height"] = Math.round(heightEdit.getValue());
...
BitmapExport.prototype.resolutionChanged = function(str) {
    ...
    widthEdit.setValue(Math.round(res * this.documentWidth));
    heightEdit.setValue(Math.round(res * this.documentHeight));
};
