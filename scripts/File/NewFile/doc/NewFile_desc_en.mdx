...
Please refer also to the command [New from Template](/en/manual/scripts/Pro/File/NewFromTemplate/doc/NewFromTemplate) to learn how to use drawing templates.
