...
// File        : scripts/Draw/Hatch/HatchFromBoundary/Tests/HatchFromBoundaryTest03.js
// Timestamp   : 2011-08-16 15:03:22
// Description : spline, pattern GRAVEL, scale 1, angle 176° [SLOW! be patient!]

include('scripts/Pro/Developer/TestingDashboard/TdbTest.js');

function HatchFromBoundaryTest03() {
    TdbTest.call(this, 'scripts/Draw/Hatch/HatchFromBoundary/Tests/HatchFromBoundaryTest03.js');
}

HatchFromBoundaryTest03.prototype = new TdbTest();

HatchFromBoundaryTest03.prototype.test00 = function() {
    qDebug('running HatchFromBoundaryTest03.test00()...');
    this.setUp();
    ...
    this.importFile('scripts/Draw/Hatch/HatchFromBoundary/Tests/data/spline.dxf');
    this.selectAll();
    this.dlgStart();
    ...
    this.verifyDrawing('HatchFromBoundaryTest03_000.dxf');
    this.tearDown();
    qDebug('finished HatchFromBoundaryTest03.test00()');
};
