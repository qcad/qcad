...
// File        : scripts/Draw/Hatch/HatchFromBoundary/Tests/HatchFromBoundaryTest07.js
// Timestamp   : 2015-11-24 14:42:44
// Description : 

include('scripts/Pro/Developer/TestingDashboard/TdbTest.js');

function HatchFromBoundaryTest07() {
    TdbTest.call(this, 'scripts/Draw/Hatch/HatchFromBoundary/Tests/HatchFromBoundaryTest07.js');
}

HatchFromBoundaryTest07.prototype = new TdbTest();

HatchFromBoundaryTest07.prototype.test00 = function() {
    qDebug('running HatchFromBoundaryTest07.test00()...');
    this.setUp();
    this.importFile('scripts/Draw/Hatch/HatchFromBoundary/Tests/data/hatch_blocks.dxf');
    ...
    this.verifyDrawing('HatchFromBoundaryTest07_000.dxf');
    this.tearDown();
    qDebug('finished HatchFromBoundaryTest07.test00()');
};
