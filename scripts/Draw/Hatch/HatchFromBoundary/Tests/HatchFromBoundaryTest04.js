...
// File        : scripts/Draw/Hatch/HatchFromBoundary/Tests/HatchFromBoundaryTest04.js
// Timestamp   : 2011-08-16 15:17:49
// Description : 

include('scripts/Pro/Developer/TestingDashboard/TdbTest.js');

function HatchFromBoundaryTest04() {
    TdbTest.call(this, 'scripts/Draw/Hatch/HatchFromBoundary/Tests/HatchFromBoundaryTest04.js');
}

HatchFromBoundaryTest04.prototype = new TdbTest();

HatchFromBoundaryTest04.prototype.test00 = function() {
    qDebug('running HatchFromBoundaryTest04.test00()...');
    this.setUp();
    ...
    this.verifyDrawing('HatchFromBoundaryTest04_000.dxf');
    this.tearDown();
    qDebug('finished HatchFromBoundaryTest04.test00()');
};
