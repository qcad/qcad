...
// File        : scripts/Draw/Hatch/HatchFromBoundary/Tests/HatchFromBoundaryTest00.js
// Timestamp   : 2011-08-16 14:34:21
// Description : contour, pattern HOUND, scale 0.5, angle 15°

include('scripts/Pro/Developer/TestingDashboard/TdbTest.js');

function HatchFromBoundaryTest00() {
    TdbTest.call(this, 'scripts/Draw/Hatch/HatchFromBoundary/Tests/HatchFromBoundaryTest00.js');
}

HatchFromBoundaryTest00.prototype = new TdbTest();

HatchFromBoundaryTest00.prototype.test00 = function() {
    qDebug('running HatchFromBoundaryTest00.test00()...');
    this.setUp();
    ...
    this.verifyDrawing('HatchFromBoundaryTest00_000.dxf');
    this.tearDown();
    qDebug('finished HatchFromBoundaryTest00.test00()');
};
