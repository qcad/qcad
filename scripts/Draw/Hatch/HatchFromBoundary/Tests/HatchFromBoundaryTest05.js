...
// File        : scripts/Draw/Hatch/HatchFromBoundary/Tests/HatchFromBoundaryTest05.js
// Timestamp   : 2015-11-24 14:30:33
// Description : 

include('scripts/Pro/Developer/TestingDashboard/TdbTest.js');

function HatchFromBoundaryTest05() {
    TdbTest.call(this, 'scripts/Draw/Hatch/HatchFromBoundary/Tests/HatchFromBoundaryTest05.js');
}

HatchFromBoundaryTest05.prototype = new TdbTest();

HatchFromBoundaryTest05.prototype.test00 = function() {
    qDebug('running HatchFromBoundaryTest05.test00()...');
    this.setUp();
    this.importFile('scripts/Draw/Hatch/HatchFromBoundary/Tests/data/hatch_block_polyline.dxf');
    ...
    this.verifyDrawing('HatchFromBoundaryTest05_000.dxf');
    this.tearDown();
    qDebug('finished HatchFromBoundaryTest05.test00()');
};
