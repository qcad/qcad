...
// File        : scripts/Draw/Hatch/HatchFromBoundary/Tests/HatchFromBoundaryTest02.js
// Timestamp   : 2011-08-16 14:54:19
// Description : contour, solid fill

include('scripts/Pro/Developer/TestingDashboard/TdbTest.js');

function HatchFromBoundaryTest02() {
    TdbTest.call(this, 'scripts/Draw/Hatch/HatchFromBoundary/Tests/HatchFromBoundaryTest02.js');
}

HatchFromBoundaryTest02.prototype = new TdbTest();

HatchFromBoundaryTest02.prototype.test00 = function() {
    qDebug('running HatchFromBoundaryTest02.test00()...');
    this.setUp();
    ...
    this.importFile('scripts/Draw/Hatch/HatchFromBoundary/Tests/data/contour.dxf');
    this.selectAll();
    this.dlgStart();
    ...
    this.dlgEnd();
    TdbTest.clickOnWidget('MainWindow::CadToolBar::MainToolsPanel::HatchFromBoundaryButton');
    this.verifyDrawing('HatchFromBoundaryTest02_000.dxf');
    this.tearDown();
    qDebug('finished HatchFromBoundaryTest02.test00()');
};
