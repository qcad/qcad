...
// File        : scripts/Draw/Hatch/Tests/HatchTest03.js
...
HatchTest03.prototype = new TdbTest();

HatchTest03.prototype.test00 = function() {
    qDebug('running HatchTest03.test00()...');
    this.setUp();
    ...
    this.importFile('scripts/Draw/Hatch/Tests/data/spline.dxf');
    this.selectAll();
    this.dlgStart();
    ...
    this.verifyDrawing('HatchTest03_000.dxf');
    this.tearDown();
    qDebug('finished HatchTest03.test00()');
};
