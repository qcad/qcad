...
LineVerticalTest00.prototype.test00 = function() {
    ...
    this.setToolOption('LineVertical/Length',  [ 10, 0 ] );
    this.setToolOption('LineVertical/ReferencePoint', '0');
    ...
    this.setToolOption('LineVertical/Length',  [ 10, 0 ] );
    this.setToolOption('LineVertical/ReferencePoint', '1');
    this.updateToolOptions();
    this.setZoom(10, new RVector(5, 5, 0) );
    ...
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.setToolOption('LineVertical/Length',  [ 10, 0 ] );
    this.setToolOption('LineVertical/ReferencePoint', '2');
    this.updateToolOptions();
    this.setZoom(10, new RVector(5, 5, 0) );
    ...
    var p = new RVector(19.9, 10);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.setToolOption('LineVertical/Length',  [ 20, 0 ] );
    this.setToolOption('LineVertical/ReferencePoint', '0');
    this.updateToolOptions();
    this.setZoom(10, new RVector(5, 5, 0) );
