...
3. Wählen Sie den Bogen, Kreis oder die Ellipse zu welcher die Linie
   tangential sein soll. Es gibt zwei mögliche Lösungen. Wenn Sie die Maus bewegen
   können Sie jeweils die Vorschau der Tangente sehen, die konstruiert würde, wenn
   Sie klicken.
