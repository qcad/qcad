...
4. Ustaw pierwszy narożnik lub środek boku wielokąta za pomocą myszy lub
 wprowadź współrzędne w wierszu poleceń.
5. Ustaw drugi, przeciwległy narożnik lub środek boku wielokąta.
