...
// File        : scripts/Draw/Line/LinePolygonPP/Tests/LinePolygonPPTest00.js
...
LinePolygonPPTest00.prototype = new TdbTest();

LinePolygonPPTest00.prototype.test00 = function() {
    qDebug('running LinePolygonPPTest00.test00()...');
    this.setUp();
    this.clickOnWidget('MainWindow::MainToolsPanel::LineMenuButton');
    this.clickOnWidget('MainWindow::LineToolsPanel::LinePolygonPPButton');
    ...
    this.verifyDrawing('LinePolygonPPTest00_000.dxf');
    this.tearDown();
    qDebug('finished LinePolygonPPTest00.test00()');
};
