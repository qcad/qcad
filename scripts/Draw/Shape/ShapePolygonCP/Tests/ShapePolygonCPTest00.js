...
// File        : scripts/Draw/Shape/ShapePolygonCP/Tests/ShapePolygonCPTest00.js
// Timestamp   : 2011-02-28 10:26:03
// Description : Regular polygons with 3 up to 8 lines, defined by center

include('scripts/Developer/TestingDashboard/TdbTest.js');

function ShapePolygonCPTest00() {
    TdbTest.call(this, 'scripts/Draw/Shape/ShapePolygonCP/Tests/ShapePolygonCPTest00.js');
}

ShapePolygonCPTest00.prototype = new TdbTest();

ShapePolygonCPTest00.prototype.test00 = function() {
    qDebug('running ShapePolygonCPTest00.test00()...');
    this.setUp();
    ...
    this.setToolOption('ShapePolygonCP/Fill', 'false');
    ...
    this.verifyDrawing('ShapePolygonCPTest00_000.dxf');
    this.tearDown();
    qDebug('finished ShapePolygonCPTest00.test00()');
};
