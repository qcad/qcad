...
// File        : scripts/Draw/Shape/ShapePolygonCP/Tests/ShapePolygonCPTest02.js
// Timestamp   : 2011-02-28 10:26:03
// Description : Regular polygons with 3 up to 8 lines, defined by center

include('scripts/Developer/TestingDashboard/TdbTest.js');

function ShapePolygonCPTest02() {
    TdbTest.call(this, 'scripts/Draw/Shape/ShapePolygonCP/Tests/ShapePolygonCPTest02.js');
}

ShapePolygonCPTest02.prototype = new TdbTest();

ShapePolygonCPTest02.prototype.test00 = function() {
    qDebug('running ShapePolygonCPTest02.test00()...');
    this.setUp();
    ...
    this.setToolOption('ShapePolygonCP/CreatePolyline', 'true');
    this.setToolOption('ShapePolygonCP/Fill', 'true');
    ...
    this.verifyDrawing('ShapePolygonCPTest02_000.dxf');
    this.tearDown();
    qDebug('finished ShapePolygonCPTest02.test00()');
};
