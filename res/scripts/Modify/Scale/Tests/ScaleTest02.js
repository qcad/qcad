...
// File        : scripts/Modify/Scale/Tests/ScaleTest02.js
// Timestamp   : 2011-08-15 11:26:18
// Description : scaling arcs, factor 0.5

include('scripts/Pro/Developer/TestingDashboard/TdbTest.js');

function ScaleTest02() {
    TdbTest.call(this, 'scripts/Modify/Scale/Tests/ScaleTest02.js');
}

ScaleTest02.prototype = new TdbTest();

ScaleTest02.prototype.test00 = function() {
    qDebug('running ScaleTest02.test00()...');
    this.setUp();
    var w = objectFromPath('MainWindow::CadToolBar::MainToolsPanel');
    this.sendMouseEvent(w, QEvent.MouseButtonPress, new QPoint(54, 457), Qt.LeftButton, 1, 0);
    var w = objectFromPath('MainWindow::CadToolBar::MainToolsPanel');
    this.sendMouseEvent(w, QEvent.MouseButtonRelease, new QPoint(54, 457), Qt.LeftButton, 0, 0);
    this.importFile('scripts/Modify/Scale/Tests/data/arcs.dxf');
    this.setZoom(4.910179640718563, new RVector(0.0256098, -7.71341, 0) );
    var p = new RVector(19.52561, 15.045122);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.triggerCommand('scale');
    this.setZoom(4.910179640718563, new RVector(0.0256098, -7.71341, 0) );
    var p = new RVector(89.380488, 90.602439);
    this.sendMouseEventModelPos(QEvent.MouseButtonPress, p, Qt.LeftButton, 1, 0);
    this.dlgStart();
    ...
    this.dlgEnd();
    this.sendMouseEventModelPos(QEvent.MouseButtonRelease, p, Qt.LeftButton, 0, 0);
    this.verifyDrawing('ScaleTest02_000.dxf');
    this.tearDown();
    qDebug('finished ScaleTest02.test00()');
};
