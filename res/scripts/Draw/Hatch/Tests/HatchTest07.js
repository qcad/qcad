...
// File        : scripts/Draw/Hatch/Tests/HatchTest07.js
// Timestamp   : 2015-11-24 14:42:44
// Description : 

include('scripts/Pro/Developer/TestingDashboard/TdbTest.js');

function HatchTest07() {
    TdbTest.call(this, 'scripts/Draw/Hatch/Tests/HatchTest07.js');
}

HatchTest07.prototype = new TdbTest();

HatchTest07.prototype.test00 = function() {
    qDebug('running HatchTest07.test00()...');
    this.setUp();
    this.importFile('scripts/Draw/Hatch/Tests/data/hatch_blocks.dxf');
    ...
    this.verifyDrawing('HatchTest07_000.dxf');
    this.tearDown();
    qDebug('finished HatchTest07.test00()');
};
