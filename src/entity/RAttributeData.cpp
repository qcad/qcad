...
RLineweight::Lineweight RAttributeData::getLineweight(bool resolve, const QStack<QSharedPointer<REntity> >& blockRefStack) const {
...
RColor RAttributeData::getColor(bool resolve, const QStack<QSharedPointer<REntity> >& blockRefStack) const {
