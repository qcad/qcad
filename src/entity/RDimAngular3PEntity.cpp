...
void RDimAngular3PEntity::init() {
    ...
    RDimAngular3PEntity::PropertyCenterZ.generateId(typeid(RDimAngular3PEntity), QT_TRANSLATE_NOOP("REntity", "Center"), QT_TRANSLATE_NOOP("REntity", "Z"), true);
...
//    RDimAngular3PEntity::PropertyExtensionLine1EndZ.generateId(typeid(RDimAngular3PEntity), QT_TRANSLATE_NOOP("REntity", "Line 1 End"), QT_TRANSLATE_NOOP("REntity", "Z"), true);
    ...
    RDimAngular3PEntity::PropertyDimArcPositionX.generateId(typeid(RDimAngular3PEntity), QT_TRANSLATE_NOOP("REntity", "Dimension Arc"), QT_TRANSLATE_NOOP("REntity", "X"), true);
    RDimAngular3PEntity::PropertyDimArcPositionY.generateId(typeid(RDimAngular3PEntity), QT_TRANSLATE_NOOP("REntity", "Dimension Arc"), QT_TRANSLATE_NOOP("REntity", "Y"), true);
    RDimAngular3PEntity::PropertyDimArcPositionZ.generateId(typeid(RDimAngular3PEntity), QT_TRANSLATE_NOOP("REntity", "Dimension Arc"), QT_TRANSLATE_NOOP("REntity", "Z"), true);
}
