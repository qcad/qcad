...
QRegExp RTextRenderer::rxAllBreak(RTextRenderer::rxAllBreakStr);
...
//                    qDebug() << "got leading space";
        ...
        optionalBreakText = rxOptionalBreak.exactMatch(textBlock);
