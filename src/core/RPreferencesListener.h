...
#ifndef RPREFERENCESLISTENER_H
#define RPREFERENCESLISTENER_H
 ...
 * \scriptable
 */
class QCADCORE_EXPORT RPreferencesListener {
public:
    virtual ~RPreferencesListener() {}
     ...
     */
    virtual void updatePreferences(RDocumentInterface* di) = 0;
};

Q_DECLARE_METATYPE(RPreferencesListener*)
