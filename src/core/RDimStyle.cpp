...
void RDimStyle::init() {
    ...
    RDimStyle::PropertyDimtxt.generateId(RDimStyle::getRtti(), tsStyle, QT_TRANSLATE_NOOP("REntity", "Text height"), false, RPropertyAttributes::DimStyleOverride);
    RDimStyle::PropertyDimgap.generateId(RDimStyle::getRtti(), tsStyle, QT_TRANSLATE_NOOP("REntity", "Dimension line gap"), false, RPropertyAttributes::DimStyleOverride);
    RDimStyle::PropertyDimasz.generateId(RDimStyle::getRtti(), tsStyle, QT_TRANSLATE_NOOP("REntity", "Arrow size"), false, RPropertyAttributes::DimStyleOverride);
    RDimStyle::PropertyDimdli.generateId(RDimStyle::getRtti(), tsStyle, QT_TRANSLATE_NOOP("REntity", "Dimension line increment"), false, RPropertyAttributes::DimStyleOverride);
    ...
    RDimStyle::PropertyDimdsep.generateId(RDimStyle::getRtti(), tsStyle, QT_TRANSLATE_NOOP("REntity", "Decimal separator"), false, RPropertyAttributes::DimStyleOverride);
    RDimStyle::PropertyDimzin.generateId(RDimStyle::getRtti(), tsStyle, QT_TRANSLATE_NOOP("REntity", "Zero suppression"), false, RPropertyAttributes::DimStyleOverride);
    RDimStyle::PropertyDimaunit.generateId(RDimStyle::getRtti(), tsStyle, QT_TRANSLATE_NOOP("REntity", "Angular format"), false, RPropertyAttributes::DimStyleOverride);
    RDimStyle::PropertyDimadec.generateId(RDimStyle::getRtti(), tsStyle, QT_TRANSLATE_NOOP("REntity", "Angular decimal places"), false, RPropertyAttributes::DimStyleOverride);
    RDimStyle::PropertyDimazin.generateId(RDimStyle::getRtti(), tsStyle, QT_TRANSLATE_NOOP("REntity", "Angular zero suppression"), false, RPropertyAttributes::DimStyleOverride);
    RDimStyle::PropertyArchTick.generateId(RDimStyle::getRtti(), tsStyle, QT_TRANSLATE_NOOP("REntity", "Architectur tick"), false, RPropertyAttributes::DimStyleOverride);
    RDimStyle::PropertyDimclrt.generateId(RDimStyle::getRtti(), tsStyle, QT_TRANSLATE_NOOP("REntity", "Text color"), false, RPropertyAttributes::DimStyleOverride);
    RDimStyle::PropertyDimblk.generateId(RDimStyle::getRtti(), tsStyle, QT_TRANSLATE_NOOP("REntity", "Arrow block"), false, RPropertyAttributes::DimStyleOverride);
    RDimStyle::PropertyDimblk1.generateId(RDimStyle::getRtti(), tsStyle, QT_TRANSLATE_NOOP("REntity", "Arrow block 1"), false, RPropertyAttributes::DimStyleOverride);
    RDimStyle::PropertyDimblk2.generateId(RDimStyle::getRtti(), tsStyle, QT_TRANSLATE_NOOP("REntity", "Arrow block 2"), false, RPropertyAttributes::DimStyleOverride);
