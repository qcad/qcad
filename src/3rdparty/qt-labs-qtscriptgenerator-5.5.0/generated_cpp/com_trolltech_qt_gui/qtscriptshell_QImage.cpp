...
void QtScriptShell_QImage::initPainter(QPainter*  painter) const
{
...
QPaintDevice*  QtScriptShell_QImage::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QImage::sharedPainter() const
{
