...
QtScriptShell_QPrintPreviewDialog::QtScriptShell_QPrintPreviewDialog(QPrinter*  printer, QWidget*  parent, Qt::WindowFlags  flags)
    : QPrintPreviewDialog(printer, parent, flags) {}

QtScriptShell_QPrintPreviewDialog::QtScriptShell_QPrintPreviewDialog(QWidget*  parent, Qt::WindowFlags  flags)
    : QPrintPreviewDialog(parent, flags) {}

QtScriptShell_QPrintPreviewDialog::~QtScriptShell_QPrintPreviewDialog() {}

void QtScriptShell_QPrintPreviewDialog::accept()
{
...
void QtScriptShell_QPrintPreviewDialog::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QPrintPreviewDialog::devType() const
{
...
void QtScriptShell_QPrintPreviewDialog::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QPrintPreviewDialog::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_QPrintPreviewDialog::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
int  QtScriptShell_QPrintPreviewDialog::exec()
{
...
void QtScriptShell_QPrintPreviewDialog::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QPrintPreviewDialog::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QPrintPreviewDialog::focusOutEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QPrintPreviewDialog::hasHeightForWidth() const
{
...
int  QtScriptShell_QPrintPreviewDialog::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QPrintPreviewDialog::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_QPrintPreviewDialog::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QPrintPreviewDialog::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QPrintPreviewDialog::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QPrintPreviewDialog::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
void QtScriptShell_QPrintPreviewDialog::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::moveEvent(QMoveEvent*  arg__1)
{
...
bool  QtScriptShell_QPrintPreviewDialog::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
void QtScriptShell_QPrintPreviewDialog::open()
{
...
QPaintEngine*  QtScriptShell_QPrintPreviewDialog::paintEngine() const
{
...
void QtScriptShell_QPrintPreviewDialog::paintEvent(QPaintEvent*  arg__1)
{
...
QPaintDevice*  QtScriptShell_QPrintPreviewDialog::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QPrintPreviewDialog::reject()
{
...
void QtScriptShell_QPrintPreviewDialog::resizeEvent(QResizeEvent*  arg__1)
{
...
QPainter*  QtScriptShell_QPrintPreviewDialog::sharedPainter() const
{
...
void QtScriptShell_QPrintPreviewDialog::showEvent(QShowEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewDialog::wheelEvent(QWheelEvent*  arg__1)
{
