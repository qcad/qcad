...
QtScriptShell_QScrollBar::QtScriptShell_QScrollBar(QWidget*  parent)
    : QScrollBar(parent) {}

QtScriptShell_QScrollBar::QtScriptShell_QScrollBar(Qt::Orientation  arg__1, QWidget*  parent)
    : QScrollBar(arg__1, parent) {}

QtScriptShell_QScrollBar::~QtScriptShell_QScrollBar() {}

void QtScriptShell_QScrollBar::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::changeEvent(QEvent*  e)
{
...
void QtScriptShell_QScrollBar::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QScrollBar::devType() const
{
...
void QtScriptShell_QScrollBar::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QScrollBar::event(QEvent*  event)
{
...
bool  QtScriptShell_QScrollBar::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QScrollBar::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QScrollBar::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QScrollBar::focusOutEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QScrollBar::hasHeightForWidth() const
{
...
int  QtScriptShell_QScrollBar::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QScrollBar::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_QScrollBar::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QScrollBar::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QScrollBar::keyPressEvent(QKeyEvent*  ev)
{
...
void QtScriptShell_QScrollBar::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QScrollBar::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_QScrollBar::minimumSizeHint() const
{
...
void QtScriptShell_QScrollBar::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::moveEvent(QMoveEvent*  arg__1)
{
...
bool  QtScriptShell_QScrollBar::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintEngine*  QtScriptShell_QScrollBar::paintEngine() const
{
...
void QtScriptShell_QScrollBar::paintEvent(QPaintEvent*  arg__1)
{
...
QPaintDevice*  QtScriptShell_QScrollBar::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QScrollBar::resizeEvent(QResizeEvent*  arg__1)
{
...
QPainter*  QtScriptShell_QScrollBar::sharedPainter() const
{
...
void QtScriptShell_QScrollBar::showEvent(QShowEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QScrollBar::wheelEvent(QWheelEvent*  arg__1)
{
