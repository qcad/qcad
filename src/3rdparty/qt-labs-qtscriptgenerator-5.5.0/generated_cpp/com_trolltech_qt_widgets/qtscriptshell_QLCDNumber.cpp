...
QtScriptShell_QLCDNumber::QtScriptShell_QLCDNumber(QWidget*  parent)
    : QLCDNumber(parent) {}

QtScriptShell_QLCDNumber::QtScriptShell_QLCDNumber(uint  numDigits, QWidget*  parent)
    : QLCDNumber(numDigits, parent) {}

QtScriptShell_QLCDNumber::~QtScriptShell_QLCDNumber() {}

void QtScriptShell_QLCDNumber::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QLCDNumber::devType() const
{
...
void QtScriptShell_QLCDNumber::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QLCDNumber::event(QEvent*  e)
{
...
bool  QtScriptShell_QLCDNumber::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QLCDNumber::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QLCDNumber::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QLCDNumber::focusOutEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QLCDNumber::hasHeightForWidth() const
{
...
int  QtScriptShell_QLCDNumber::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QLCDNumber::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_QLCDNumber::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QLCDNumber::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QLCDNumber::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QLCDNumber::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_QLCDNumber::minimumSizeHint() const
{
...
void QtScriptShell_QLCDNumber::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::moveEvent(QMoveEvent*  arg__1)
{
...
bool  QtScriptShell_QLCDNumber::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintEngine*  QtScriptShell_QLCDNumber::paintEngine() const
{
...
void QtScriptShell_QLCDNumber::paintEvent(QPaintEvent*  arg__1)
{
...
QPaintDevice*  QtScriptShell_QLCDNumber::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QLCDNumber::resizeEvent(QResizeEvent*  arg__1)
{
...
QPainter*  QtScriptShell_QLCDNumber::sharedPainter() const
{
...
void QtScriptShell_QLCDNumber::showEvent(QShowEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QLCDNumber::wheelEvent(QWheelEvent*  arg__1)
{
