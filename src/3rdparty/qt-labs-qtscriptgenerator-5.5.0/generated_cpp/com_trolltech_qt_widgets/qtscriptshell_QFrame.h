#ifndef QTSCRIPTSHELL_QFRAME_H
#define QTSCRIPTSHELL_QFRAME_H
...
class QtScriptShell_QFrame : public QFrame
{
public:
    QtScriptShell_QFrame(QWidget*  parent = 0, Qt::WindowFlags  f = 0);
