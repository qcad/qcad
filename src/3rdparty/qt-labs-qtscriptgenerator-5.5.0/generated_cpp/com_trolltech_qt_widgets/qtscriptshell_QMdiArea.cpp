...
QtScriptShell_QMdiArea::QtScriptShell_QMdiArea(QWidget*  parent)
    : QMdiArea(parent) {}
...
bool  QtScriptShell_QMdiArea::eventFilter(QObject*  object, QEvent*  event)
{
...
bool  QtScriptShell_QMdiArea::hasHeightForWidth() const
{
...
void QtScriptShell_QMdiArea::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QMdiArea::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QMdiArea::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QMdiArea::scrollContentsBy(int  dx, int  dy)
{
...
void QtScriptShell_QMdiArea::setupViewport(QWidget*  viewport)
{
...
QPainter*  QtScriptShell_QMdiArea::sharedPainter() const
{
...
QSize  QtScriptShell_QMdiArea::viewportSizeHint() const
{
