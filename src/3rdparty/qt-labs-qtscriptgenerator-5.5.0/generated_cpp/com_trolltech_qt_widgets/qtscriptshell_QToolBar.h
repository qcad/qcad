...
class QtScriptShell_QToolBar : public QToolBar
{
public:
    QtScriptShell_QToolBar(QWidget*  parent = 0);
    QtScriptShell_QToolBar(const QString&  title, QWidget*  parent = 0);
...
#endif // QTSCRIPTSHELL_QTOOLBAR_H
