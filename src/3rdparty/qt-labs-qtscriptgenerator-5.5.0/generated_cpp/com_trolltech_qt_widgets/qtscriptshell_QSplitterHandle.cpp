...
bool  QtScriptShell_QSplitterHandle::hasHeightForWidth() const
{
...
void QtScriptShell_QSplitterHandle::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QSplitterHandle::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QSplitterHandle::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QSplitterHandle::sharedPainter() const
{
