...
static const int qtscript_QDomNotation_function_lengths[] = {
    1
    // static
    // prototype
    , 0
    ...
    QScriptContext *context, const char *functionName, const char *signatures)
{
    ...
    return context->throwError(QString::fromLatin1("QDomNotation::%0(): could not find a function match; candidates are:\n%1")
...
QScriptValue qtscript_create_QDomNotation_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 3; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QDomNotation_prototype_call, qtscript_QDomNotation_function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QDomNotation_static_call, proto, qtscript_QDomNotation_function_lengths[0]);
