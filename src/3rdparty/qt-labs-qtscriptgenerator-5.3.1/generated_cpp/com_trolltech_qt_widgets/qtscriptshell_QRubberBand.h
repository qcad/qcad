#ifndef QTSCRIPTSHELL_QRUBBERBAND_H
...
class QtScriptShell_QRubberBand : public QRubberBand
{
public:
    QtScriptShell_QRubberBand(QRubberBand::Shape  arg__1, QWidget*  arg__2 = 0);
...
#endif // QTSCRIPTSHELL_QRUBBERBAND_H
