...
QtScriptShell_QCommandLinkButton::QtScriptShell_QCommandLinkButton(QWidget*  parent)
    : QCommandLinkButton(parent) {}

QtScriptShell_QCommandLinkButton::QtScriptShell_QCommandLinkButton(const QString&  text, QWidget*  parent)
    : QCommandLinkButton(text, parent) {}

QtScriptShell_QCommandLinkButton::QtScriptShell_QCommandLinkButton(const QString&  text, const QString&  description, QWidget*  parent)
...
bool  QtScriptShell_QCommandLinkButton::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
bool  QtScriptShell_QCommandLinkButton::hasHeightForWidth() const
{
...
void QtScriptShell_QCommandLinkButton::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QCommandLinkButton::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QCommandLinkButton::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QCommandLinkButton::sharedPainter() const
{
