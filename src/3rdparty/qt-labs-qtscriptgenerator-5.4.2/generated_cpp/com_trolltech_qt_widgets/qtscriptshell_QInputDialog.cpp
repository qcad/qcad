...
QtScriptShell_QInputDialog::QtScriptShell_QInputDialog(QWidget*  parent, Qt::WindowFlags  flags)
    : QInputDialog(parent, flags) {}

QtScriptShell_QInputDialog::~QtScriptShell_QInputDialog() {}

void QtScriptShell_QInputDialog::accept()
{
...
void QtScriptShell_QInputDialog::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QInputDialog::devType() const
{
...
void QtScriptShell_QInputDialog::done(int  result)
{
...
void QtScriptShell_QInputDialog::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QInputDialog::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_QInputDialog::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
int  QtScriptShell_QInputDialog::exec()
{
...
void QtScriptShell_QInputDialog::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QInputDialog::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QInputDialog::focusOutEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QInputDialog::hasHeightForWidth() const
{
...
int  QtScriptShell_QInputDialog::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QInputDialog::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_QInputDialog::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QInputDialog::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QInputDialog::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QInputDialog::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
void QtScriptShell_QInputDialog::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::moveEvent(QMoveEvent*  arg__1)
{
...
bool  QtScriptShell_QInputDialog::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
void QtScriptShell_QInputDialog::open()
{
...
QPaintEngine*  QtScriptShell_QInputDialog::paintEngine() const
{
...
void QtScriptShell_QInputDialog::paintEvent(QPaintEvent*  arg__1)
{
...
QPaintDevice*  QtScriptShell_QInputDialog::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QInputDialog::reject()
{
...
void QtScriptShell_QInputDialog::resizeEvent(QResizeEvent*  arg__1)
{
...
QPainter*  QtScriptShell_QInputDialog::sharedPainter() const
{
...
void QtScriptShell_QInputDialog::showEvent(QShowEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QInputDialog::wheelEvent(QWheelEvent*  arg__1)
{
