...
QtScriptShell_QStackedWidget::QtScriptShell_QStackedWidget(QWidget*  parent)
    : QStackedWidget(parent) {}

QtScriptShell_QStackedWidget::~QtScriptShell_QStackedWidget() {}

void QtScriptShell_QStackedWidget::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QStackedWidget::devType() const
{
...
void QtScriptShell_QStackedWidget::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QStackedWidget::event(QEvent*  e)
{
...
bool  QtScriptShell_QStackedWidget::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QStackedWidget::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QStackedWidget::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QStackedWidget::focusOutEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QStackedWidget::hasHeightForWidth() const
{
...
int  QtScriptShell_QStackedWidget::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QStackedWidget::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_QStackedWidget::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QStackedWidget::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QStackedWidget::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QStackedWidget::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_QStackedWidget::minimumSizeHint() const
{
...
void QtScriptShell_QStackedWidget::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::moveEvent(QMoveEvent*  arg__1)
{
...
bool  QtScriptShell_QStackedWidget::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintEngine*  QtScriptShell_QStackedWidget::paintEngine() const
{
...
void QtScriptShell_QStackedWidget::paintEvent(QPaintEvent*  arg__1)
{
...
QPaintDevice*  QtScriptShell_QStackedWidget::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QStackedWidget::resizeEvent(QResizeEvent*  arg__1)
{
...
QPainter*  QtScriptShell_QStackedWidget::sharedPainter() const
{
...
void QtScriptShell_QStackedWidget::showEvent(QShowEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QStackedWidget::wheelEvent(QWheelEvent*  arg__1)
{
