...
QtScriptShell_QTabWidget::QtScriptShell_QTabWidget(QWidget*  parent)
    : QTabWidget(parent) {}
...
bool  QtScriptShell_QTabWidget::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
bool  QtScriptShell_QTabWidget::hasHeightForWidth() const
{
...
void QtScriptShell_QTabWidget::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QTabWidget::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QTabWidget::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QTabWidget::sharedPainter() const
{
