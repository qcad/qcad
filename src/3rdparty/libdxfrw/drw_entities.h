...
public:
    ...
    int drawingDirection;  /*!< Drawing direction, code 72, 1: left to right, 3: top to bottom, 5: by style*/
    int attachmentPoint; /*!< Attachment point.*/
    int lineSpacingStyle; /*!< code 73*/
private:
    bool haveXAxis;
};
...
public:
    ...
    std::vector<DRW_HatchDefine* > defines;
