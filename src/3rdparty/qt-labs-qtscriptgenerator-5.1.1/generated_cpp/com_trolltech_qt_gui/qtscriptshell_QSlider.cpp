...
QtScriptShell_QSlider::QtScriptShell_QSlider(QWidget*  parent)
    : QSlider(parent) {}

QtScriptShell_QSlider::QtScriptShell_QSlider(Qt::Orientation  orientation, QWidget*  parent)
    : QSlider(orientation, parent) {}

QtScriptShell_QSlider::~QtScriptShell_QSlider() {}

void QtScriptShell_QSlider::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QSlider::changeEvent(QEvent*  e)
{
...
void QtScriptShell_QSlider::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QSlider::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QSlider::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QSlider::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QSlider::devType() const
{
...
void QtScriptShell_QSlider::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QSlider::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QSlider::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QSlider::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QSlider::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QSlider::event(QEvent*  event)
{
...
bool  QtScriptShell_QSlider::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QSlider::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QSlider::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QSlider::focusOutEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QSlider::hasHeightForWidth() const
{
...
int  QtScriptShell_QSlider::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QSlider::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QSlider::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_QSlider::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QSlider::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QSlider::keyPressEvent(QKeyEvent*  ev)
{
...
void QtScriptShell_QSlider::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QSlider::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QSlider::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
void QtScriptShell_QSlider::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QSlider::mouseMoveEvent(QMouseEvent*  ev)
{
...
void QtScriptShell_QSlider::mousePressEvent(QMouseEvent*  ev)
{
...
void QtScriptShell_QSlider::mouseReleaseEvent(QMouseEvent*  ev)
{
...
void QtScriptShell_QSlider::moveEvent(QMoveEvent*  arg__1)
{
...
bool  QtScriptShell_QSlider::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintEngine*  QtScriptShell_QSlider::paintEngine() const
{
...
void QtScriptShell_QSlider::paintEvent(QPaintEvent*  ev)
{
...
QPaintDevice*  QtScriptShell_QSlider::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QSlider::resizeEvent(QResizeEvent*  arg__1)
{
...
QPainter*  QtScriptShell_QSlider::sharedPainter() const
{
...
void QtScriptShell_QSlider::showEvent(QShowEvent*  arg__1)
{
...
void QtScriptShell_QSlider::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QSlider::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QSlider::wheelEvent(QWheelEvent*  e)
{
