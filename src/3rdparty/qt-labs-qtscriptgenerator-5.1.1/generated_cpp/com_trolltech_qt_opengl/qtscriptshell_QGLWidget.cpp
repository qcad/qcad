...
QtScriptShell_QGLWidget::QtScriptShell_QGLWidget(QGLContext*  context, QWidget*  parent, const QGLWidget*  shareWidget, Qt::WindowFlags  f)
    : QGLWidget(context, parent, shareWidget, f) {}

QtScriptShell_QGLWidget::QtScriptShell_QGLWidget(QWidget*  parent, const QGLWidget*  shareWidget, Qt::WindowFlags  f)
    : QGLWidget(parent, shareWidget, f) {}

QtScriptShell_QGLWidget::QtScriptShell_QGLWidget(const QGLFormat&  format, QWidget*  parent, const QGLWidget*  shareWidget, Qt::WindowFlags  f)
...
bool  QtScriptShell_QGLWidget::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
{
    QScriptValue _q_function = __qtscript_self.property("glDraw");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("glDraw") & QScriptValue::QObjectMember)) {
        QGLWidget::glDraw();
    } else {
        _q_function.call(__qtscript_self);
    }
...
{
    QScriptValue _q_function = __qtscript_self.property("glInit");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("glInit") & QScriptValue::QObjectMember)) {
        QGLWidget::glInit();
    } else {
        _q_function.call(__qtscript_self);
    }
...
bool  QtScriptShell_QGLWidget::hasHeightForWidth() const
{
...
void QtScriptShell_QGLWidget::initPainter(QPainter*  painter) const
{
...
{
    QScriptValue _q_function = __qtscript_self.property("initializeGL");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("initializeGL") & QScriptValue::QObjectMember)) {
...
{
    QScriptValue _q_function = __qtscript_self.property("initializeOverlayGL");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("initializeOverlayGL") & QScriptValue::QObjectMember)) {
...
bool  QtScriptShell_QGLWidget::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
{
    QScriptValue _q_function = __qtscript_self.property("paintGL");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("paintGL") & QScriptValue::QObjectMember)) {
        QGLWidget::paintGL();
    } else {
        _q_function.call(__qtscript_self);
    }
...
{
    QScriptValue _q_function = __qtscript_self.property("paintOverlayGL");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("paintOverlayGL") & QScriptValue::QObjectMember)) {
...
QPaintDevice*  QtScriptShell_QGLWidget::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QGLWidget::resizeGL(int  w, int  h)
{
    QScriptValue _q_function = __qtscript_self.property("resizeGL");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("resizeGL") & QScriptValue::QObjectMember)) {
        ...
        _q_function.call(__qtscript_self,
            ...
            << qScriptValueFromValue(_q_engine, h));
    }
}

void QtScriptShell_QGLWidget::resizeOverlayGL(int  w, int  h)
{
    QScriptValue _q_function = __qtscript_self.property("resizeOverlayGL");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("resizeOverlayGL") & QScriptValue::QObjectMember)) {
...
QPainter*  QtScriptShell_QGLWidget::sharedPainter() const
{
...
{
    QScriptValue _q_function = __qtscript_self.property("updateGL");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("updateGL") & QScriptValue::QObjectMember)) {
        QGLWidget::updateGL();
    } else {
        _q_function.call(__qtscript_self);
    }
...
{
    QScriptValue _q_function = __qtscript_self.property("updateOverlayGL");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("updateOverlayGL") & QScriptValue::QObjectMember)) {
