...
static const int qtscript_QTextCodecPlugin_function_lengths[] = {
    1
    // static
    // prototype
    , 0
...
QScriptValue qtscript_create_QTextCodecPlugin_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 6; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QTextCodecPlugin_prototype_call, qtscript_QTextCodecPlugin_function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QTextCodecPlugin_static_call, proto, qtscript_QTextCodecPlugin_function_lengths[0]);
