...
QtScriptShell_QWebView::QtScriptShell_QWebView(QWidget*  parent)
    : QWebView(parent) {}
...
QWebView*  QtScriptShell_QWebView::createWindow(QWebPage::WebWindowType  type)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<QWebView* >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
bool  QtScriptShell_QWebView::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
