...
QtScriptShell_QSplitter::QtScriptShell_QSplitter(QWidget*  parent)
    : QSplitter(parent) {}

QtScriptShell_QSplitter::QtScriptShell_QSplitter(Qt::Orientation  arg__1, QWidget*  parent)
    : QSplitter(arg__1, parent) {}

QtScriptShell_QSplitter::~QtScriptShell_QSplitter() {}

void QtScriptShell_QSplitter::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
QSplitterHandle*  QtScriptShell_QSplitter::createHandle()
{
    QScriptValue _q_function = __qtscript_self.property("createHandle");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("createHandle") & QScriptValue::QObjectMember)) {
        return QSplitter::createHandle();
    } else {
        return qscriptvalue_cast<QSplitterHandle* >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_QSplitter::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QSplitter::devType() const
{
...
void QtScriptShell_QSplitter::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QSplitter::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_QSplitter::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QSplitter::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QSplitter::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QSplitter::focusOutEvent(QFocusEvent*  arg__1)
{
...
int  QtScriptShell_QSplitter::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QSplitter::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QSplitter::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QSplitter::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::languageChange()
{
...
void QtScriptShell_QSplitter::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QSplitter::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
void QtScriptShell_QSplitter::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_QSplitter::paintEngine() const
{
...
void QtScriptShell_QSplitter::paintEvent(QPaintEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::resizeEvent(QResizeEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::showEvent(QShowEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QSplitter::wheelEvent(QWheelEvent*  arg__1)
{
