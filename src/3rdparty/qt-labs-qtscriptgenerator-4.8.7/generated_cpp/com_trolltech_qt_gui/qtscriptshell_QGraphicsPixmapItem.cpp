...
QtScriptShell_QGraphicsPixmapItem::QtScriptShell_QGraphicsPixmapItem(QGraphicsItem*  parent, QGraphicsScene*  scene)
    : QGraphicsPixmapItem(parent, scene) {}

QtScriptShell_QGraphicsPixmapItem::QtScriptShell_QGraphicsPixmapItem(const QPixmap&  pixmap, QGraphicsItem*  parent, QGraphicsScene*  scene)
