...
QtScriptShell_QGraphicsLineItem::QtScriptShell_QGraphicsLineItem(QGraphicsItem*  parent, QGraphicsScene*  scene)
    : QGraphicsLineItem(parent, scene) {}

QtScriptShell_QGraphicsLineItem::QtScriptShell_QGraphicsLineItem(const QLineF&  line, QGraphicsItem*  parent, QGraphicsScene*  scene)
    : QGraphicsLineItem(line, parent, scene) {}

QtScriptShell_QGraphicsLineItem::QtScriptShell_QGraphicsLineItem(qreal  x1, qreal  y1, qreal  x2, qreal  y2, QGraphicsItem*  parent, QGraphicsScene*  scene)
