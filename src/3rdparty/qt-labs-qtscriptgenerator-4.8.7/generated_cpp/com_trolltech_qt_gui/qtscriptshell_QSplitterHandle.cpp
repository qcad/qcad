...
QtScriptShell_QSplitterHandle::QtScriptShell_QSplitterHandle(Qt::Orientation  o, QSplitter*  parent)
    : QSplitterHandle(o, parent) {}

QtScriptShell_QSplitterHandle::~QtScriptShell_QSplitterHandle() {}

void QtScriptShell_QSplitterHandle::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QSplitterHandle::devType() const
{
...
void QtScriptShell_QSplitterHandle::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QSplitterHandle::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_QSplitterHandle::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QSplitterHandle::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QSplitterHandle::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QSplitterHandle::focusOutEvent(QFocusEvent*  arg__1)
{
...
int  QtScriptShell_QSplitterHandle::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QSplitterHandle::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QSplitterHandle::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QSplitterHandle::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::languageChange()
{
...
void QtScriptShell_QSplitterHandle::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QSplitterHandle::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_QSplitterHandle::minimumSizeHint() const
{
...
void QtScriptShell_QSplitterHandle::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_QSplitterHandle::paintEngine() const
{
...
void QtScriptShell_QSplitterHandle::paintEvent(QPaintEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::resizeEvent(QResizeEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::showEvent(QShowEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QSplitterHandle::wheelEvent(QWheelEvent*  arg__1)
{
