...
QtScriptShell_QGraphicsRectItem::QtScriptShell_QGraphicsRectItem(QGraphicsItem*  parent, QGraphicsScene*  scene)
    : QGraphicsRectItem(parent, scene) {}

QtScriptShell_QGraphicsRectItem::QtScriptShell_QGraphicsRectItem(const QRectF&  rect, QGraphicsItem*  parent, QGraphicsScene*  scene)
    : QGraphicsRectItem(rect, parent, scene) {}

QtScriptShell_QGraphicsRectItem::QtScriptShell_QGraphicsRectItem(qreal  x, qreal  y, qreal  w, qreal  h, QGraphicsItem*  parent, QGraphicsScene*  scene)
