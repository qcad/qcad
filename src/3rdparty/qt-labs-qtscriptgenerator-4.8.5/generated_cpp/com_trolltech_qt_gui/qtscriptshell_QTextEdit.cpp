...
QtScriptShell_QTextEdit::QtScriptShell_QTextEdit(QWidget*  parent)
    : QTextEdit(parent) {}

QtScriptShell_QTextEdit::QtScriptShell_QTextEdit(const QString&  text, QWidget*  parent)
    : QTextEdit(text, parent) {}

QtScriptShell_QTextEdit::~QtScriptShell_QTextEdit() {}

void QtScriptShell_QTextEdit::actionEvent(QActionEvent*  arg__1)
{
...
bool  QtScriptShell_QTextEdit::canInsertFromMimeData(const QMimeData*  source) const
{
...
void QtScriptShell_QTextEdit::changeEvent(QEvent*  e)
{
...
void QtScriptShell_QTextEdit::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QTextEdit::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QTextEdit::contextMenuEvent(QContextMenuEvent*  e)
{
...
QMimeData*  QtScriptShell_QTextEdit::createMimeDataFromSelection() const
{
...
void QtScriptShell_QTextEdit::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QTextEdit::devType() const
{
...
void QtScriptShell_QTextEdit::dragEnterEvent(QDragEnterEvent*  e)
{
...
void QtScriptShell_QTextEdit::dragLeaveEvent(QDragLeaveEvent*  e)
{
...
void QtScriptShell_QTextEdit::dragMoveEvent(QDragMoveEvent*  e)
{
...
void QtScriptShell_QTextEdit::dropEvent(QDropEvent*  e)
{
...
void QtScriptShell_QTextEdit::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QTextEdit::event(QEvent*  e)
{
...
bool  QtScriptShell_QTextEdit::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QTextEdit::focusInEvent(QFocusEvent*  e)
{
...
bool  QtScriptShell_QTextEdit::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QTextEdit::focusOutEvent(QFocusEvent*  e)
{
...
int  QtScriptShell_QTextEdit::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QTextEdit::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QTextEdit::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QTextEdit::inputMethodQuery(Qt::InputMethodQuery  property) const
{
...
void QtScriptShell_QTextEdit::insertFromMimeData(const QMimeData*  source)
{
...
void QtScriptShell_QTextEdit::keyPressEvent(QKeyEvent*  e)
{
...
void QtScriptShell_QTextEdit::keyReleaseEvent(QKeyEvent*  e)
{
...
void QtScriptShell_QTextEdit::languageChange()
{
...
void QtScriptShell_QTextEdit::leaveEvent(QEvent*  arg__1)
{
...
QVariant  QtScriptShell_QTextEdit::loadResource(int  type, const QUrl&  name)
{
...
int  QtScriptShell_QTextEdit::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
void QtScriptShell_QTextEdit::mouseDoubleClickEvent(QMouseEvent*  e)
{
...
void QtScriptShell_QTextEdit::mouseMoveEvent(QMouseEvent*  e)
{
...
void QtScriptShell_QTextEdit::mousePressEvent(QMouseEvent*  e)
{
...
void QtScriptShell_QTextEdit::mouseReleaseEvent(QMouseEvent*  e)
{
...
void QtScriptShell_QTextEdit::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_QTextEdit::paintEngine() const
{
...
void QtScriptShell_QTextEdit::paintEvent(QPaintEvent*  e)
{
...
void QtScriptShell_QTextEdit::resizeEvent(QResizeEvent*  e)
{
...
void QtScriptShell_QTextEdit::scrollContentsBy(int  dx, int  dy)
{
...
void QtScriptShell_QTextEdit::showEvent(QShowEvent*  arg__1)
{
...
void QtScriptShell_QTextEdit::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QTextEdit::timerEvent(QTimerEvent*  e)
{
...
bool  QtScriptShell_QTextEdit::viewportEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QTextEdit::wheelEvent(QWheelEvent*  e)
{
