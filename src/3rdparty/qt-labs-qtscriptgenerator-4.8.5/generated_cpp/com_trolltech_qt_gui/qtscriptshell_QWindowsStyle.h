#ifndef QTSCRIPTSHELL_QWINDOWSSTYLE_H
#define QTSCRIPTSHELL_QWINDOWSSTYLE_H

#include <qwindowsstyle.h>

#include <QtScript/qscriptvalue.h>

class QtScriptShell_QWindowsStyle : public QWindowsStyle
{
public:
    ...
    int  pixelMetric(QStyle::PixelMetric  pm, const QStyleOption*  option = 0, const QWidget*  widget = 0) const;
...
#endif // QTSCRIPTSHELL_QWINDOWSSTYLE_H
