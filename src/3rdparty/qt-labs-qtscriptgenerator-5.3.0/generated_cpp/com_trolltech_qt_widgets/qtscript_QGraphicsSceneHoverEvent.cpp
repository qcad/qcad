...
static const int qtscript_QGraphicsSceneHoverEvent_function_lengths[] = {
    1
    // static
    // prototype
    , 0
    ...
    QScriptContext *context, const char *functionName, const char *signatures)
{
    ...
    return context->throwError(QString::fromLatin1("QGraphicsSceneHoverEvent::%0(): could not find a function match; candidates are:\n%1")
...
QScriptValue qtscript_create_QGraphicsSceneHoverEvent_class(QScriptEngine *engine)
{
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QGraphicsSceneHoverEvent_static_call, proto, qtscript_QGraphicsSceneHoverEvent_function_lengths[0]);
