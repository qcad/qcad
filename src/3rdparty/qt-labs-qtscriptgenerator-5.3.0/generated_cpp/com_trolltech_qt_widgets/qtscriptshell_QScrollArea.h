#ifndef QTSCRIPTSHELL_QSCROLLAREA_H
#define QTSCRIPTSHELL_QSCROLLAREA_H
...
class QtScriptShell_QScrollArea : public QScrollArea
{
public:
    QtScriptShell_QScrollArea(QWidget*  parent = 0);
...
#endif // QTSCRIPTSHELL_QSCROLLAREA_H
