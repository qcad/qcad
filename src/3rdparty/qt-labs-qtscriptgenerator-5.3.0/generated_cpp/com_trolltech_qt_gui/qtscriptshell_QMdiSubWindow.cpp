...
QtScriptShell_QMdiSubWindow::QtScriptShell_QMdiSubWindow(QWidget*  parent, Qt::WindowFlags  flags)
    : QMdiSubWindow(parent, flags) {}

QtScriptShell_QMdiSubWindow::~QtScriptShell_QMdiSubWindow() {}

void QtScriptShell_QMdiSubWindow::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QMdiSubWindow::changeEvent(QEvent*  changeEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, changeEvent));
    }
}

void QtScriptShell_QMdiSubWindow::childEvent(QChildEvent*  childEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, childEvent));
    }
}

void QtScriptShell_QMdiSubWindow::closeEvent(QCloseEvent*  closeEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, closeEvent));
    }
}

void QtScriptShell_QMdiSubWindow::contextMenuEvent(QContextMenuEvent*  contextMenuEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, contextMenuEvent));
    }
}

void QtScriptShell_QMdiSubWindow::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QMdiSubWindow::devType() const
{
...
void QtScriptShell_QMdiSubWindow::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QMdiSubWindow::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QMdiSubWindow::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QMdiSubWindow::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QMdiSubWindow::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QMdiSubWindow::event(QEvent*  event)
{
...
bool  QtScriptShell_QMdiSubWindow::eventFilter(QObject*  object, QEvent*  event)
{
...
void QtScriptShell_QMdiSubWindow::focusInEvent(QFocusEvent*  focusInEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, focusInEvent));
    }
}

bool  QtScriptShell_QMdiSubWindow::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QMdiSubWindow::focusOutEvent(QFocusEvent*  focusOutEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, focusOutEvent));
    }
}

bool  QtScriptShell_QMdiSubWindow::hasHeightForWidth() const
{
...
int  QtScriptShell_QMdiSubWindow::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QMdiSubWindow::hideEvent(QHideEvent*  hideEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, hideEvent));
    }
}

void QtScriptShell_QMdiSubWindow::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_QMdiSubWindow::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QMdiSubWindow::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QMdiSubWindow::keyPressEvent(QKeyEvent*  keyEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, keyEvent));
    }
}

void QtScriptShell_QMdiSubWindow::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QMdiSubWindow::leaveEvent(QEvent*  leaveEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, leaveEvent));
    }
}

int  QtScriptShell_QMdiSubWindow::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
void QtScriptShell_QMdiSubWindow::mouseDoubleClickEvent(QMouseEvent*  mouseEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, mouseEvent));
    }
}

void QtScriptShell_QMdiSubWindow::mouseMoveEvent(QMouseEvent*  mouseEvent)
{
...
void QtScriptShell_QMdiSubWindow::mousePressEvent(QMouseEvent*  mouseEvent)
{
...
void QtScriptShell_QMdiSubWindow::mouseReleaseEvent(QMouseEvent*  mouseEvent)
{
...
void QtScriptShell_QMdiSubWindow::moveEvent(QMoveEvent*  moveEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, moveEvent));
    }
}

bool  QtScriptShell_QMdiSubWindow::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintEngine*  QtScriptShell_QMdiSubWindow::paintEngine() const
{
...
void QtScriptShell_QMdiSubWindow::paintEvent(QPaintEvent*  paintEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, paintEvent));
    }
}

QPaintDevice*  QtScriptShell_QMdiSubWindow::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QMdiSubWindow::resizeEvent(QResizeEvent*  resizeEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, resizeEvent));
    }
}

QPainter*  QtScriptShell_QMdiSubWindow::sharedPainter() const
{
...
void QtScriptShell_QMdiSubWindow::showEvent(QShowEvent*  showEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, showEvent));
    }
}

void QtScriptShell_QMdiSubWindow::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QMdiSubWindow::timerEvent(QTimerEvent*  timerEvent)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, timerEvent));
    }
}

void QtScriptShell_QMdiSubWindow::wheelEvent(QWheelEvent*  arg__1)
{
