...
QtScriptShell_QAbstractSpinBox::QtScriptShell_QAbstractSpinBox(QWidget*  parent)
    : QAbstractSpinBox(parent) {}

QtScriptShell_QAbstractSpinBox::~QtScriptShell_QAbstractSpinBox() {}

void QtScriptShell_QAbstractSpinBox::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QAbstractSpinBox::changeEvent(QEvent*  event)
{
...
void QtScriptShell_QAbstractSpinBox::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QAbstractSpinBox::clear()
{
...
void QtScriptShell_QAbstractSpinBox::closeEvent(QCloseEvent*  event)
{
...
void QtScriptShell_QAbstractSpinBox::contextMenuEvent(QContextMenuEvent*  event)
{
...
void QtScriptShell_QAbstractSpinBox::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QAbstractSpinBox::devType() const
{
...
void QtScriptShell_QAbstractSpinBox::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QAbstractSpinBox::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QAbstractSpinBox::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QAbstractSpinBox::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QAbstractSpinBox::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QAbstractSpinBox::event(QEvent*  event)
{
...
bool  QtScriptShell_QAbstractSpinBox::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QAbstractSpinBox::fixup(QString&  input) const
{
...
void QtScriptShell_QAbstractSpinBox::focusInEvent(QFocusEvent*  event)
{
...
bool  QtScriptShell_QAbstractSpinBox::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QAbstractSpinBox::focusOutEvent(QFocusEvent*  event)
{
...
bool  QtScriptShell_QAbstractSpinBox::hasHeightForWidth() const
{
...
int  QtScriptShell_QAbstractSpinBox::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QAbstractSpinBox::hideEvent(QHideEvent*  event)
{
...
void QtScriptShell_QAbstractSpinBox::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_QAbstractSpinBox::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QAbstractSpinBox::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QAbstractSpinBox::keyPressEvent(QKeyEvent*  event)
{
...
void QtScriptShell_QAbstractSpinBox::keyReleaseEvent(QKeyEvent*  event)
{
...
void QtScriptShell_QAbstractSpinBox::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QAbstractSpinBox::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
void QtScriptShell_QAbstractSpinBox::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QAbstractSpinBox::mouseMoveEvent(QMouseEvent*  event)
{
...
void QtScriptShell_QAbstractSpinBox::mousePressEvent(QMouseEvent*  event)
{
...
void QtScriptShell_QAbstractSpinBox::mouseReleaseEvent(QMouseEvent*  event)
{
...
void QtScriptShell_QAbstractSpinBox::moveEvent(QMoveEvent*  arg__1)
{
...
bool  QtScriptShell_QAbstractSpinBox::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintEngine*  QtScriptShell_QAbstractSpinBox::paintEngine() const
{
...
void QtScriptShell_QAbstractSpinBox::paintEvent(QPaintEvent*  event)
{
...
QPaintDevice*  QtScriptShell_QAbstractSpinBox::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QAbstractSpinBox::resizeEvent(QResizeEvent*  event)
{
...
QPainter*  QtScriptShell_QAbstractSpinBox::sharedPainter() const
{
...
void QtScriptShell_QAbstractSpinBox::showEvent(QShowEvent*  event)
{
...
void QtScriptShell_QAbstractSpinBox::stepBy(int  steps)
{
...
QAbstractSpinBox::StepEnabled  QtScriptShell_QAbstractSpinBox::stepEnabled() const
{
...
void QtScriptShell_QAbstractSpinBox::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QAbstractSpinBox::timerEvent(QTimerEvent*  event)
{
...
QValidator::State  QtScriptShell_QAbstractSpinBox::validate(QString&  input, int&  pos) const
{
...
void QtScriptShell_QAbstractSpinBox::wheelEvent(QWheelEvent*  event)
{
