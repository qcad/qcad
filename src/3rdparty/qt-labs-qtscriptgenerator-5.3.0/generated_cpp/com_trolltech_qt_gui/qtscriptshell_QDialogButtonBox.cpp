...
QtScriptShell_QDialogButtonBox::QtScriptShell_QDialogButtonBox(QDialogButtonBox::StandardButtons  buttons, Qt::Orientation  orientation, QWidget*  parent)
    : QDialogButtonBox(buttons, orientation, parent) {}

QtScriptShell_QDialogButtonBox::QtScriptShell_QDialogButtonBox(QWidget*  parent)
    : QDialogButtonBox(parent) {}

QtScriptShell_QDialogButtonBox::QtScriptShell_QDialogButtonBox(Qt::Orientation  orientation, QWidget*  parent)
    : QDialogButtonBox(orientation, parent) {}

QtScriptShell_QDialogButtonBox::~QtScriptShell_QDialogButtonBox() {}

void QtScriptShell_QDialogButtonBox::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::changeEvent(QEvent*  event)
{
...
void QtScriptShell_QDialogButtonBox::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QDialogButtonBox::devType() const
{
...
void QtScriptShell_QDialogButtonBox::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QDialogButtonBox::event(QEvent*  event)
{
...
bool  QtScriptShell_QDialogButtonBox::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QDialogButtonBox::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QDialogButtonBox::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QDialogButtonBox::focusOutEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QDialogButtonBox::hasHeightForWidth() const
{
...
int  QtScriptShell_QDialogButtonBox::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QDialogButtonBox::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_QDialogButtonBox::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QDialogButtonBox::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QDialogButtonBox::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QDialogButtonBox::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_QDialogButtonBox::minimumSizeHint() const
{
...
void QtScriptShell_QDialogButtonBox::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::moveEvent(QMoveEvent*  arg__1)
{
...
bool  QtScriptShell_QDialogButtonBox::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintEngine*  QtScriptShell_QDialogButtonBox::paintEngine() const
{
...
void QtScriptShell_QDialogButtonBox::paintEvent(QPaintEvent*  arg__1)
{
...
QPaintDevice*  QtScriptShell_QDialogButtonBox::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QDialogButtonBox::resizeEvent(QResizeEvent*  arg__1)
{
...
QPainter*  QtScriptShell_QDialogButtonBox::sharedPainter() const
{
...
void QtScriptShell_QDialogButtonBox::showEvent(QShowEvent*  arg__1)
{
...
QSize  QtScriptShell_QDialogButtonBox::sizeHint() const
{
...
void QtScriptShell_QDialogButtonBox::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QDialogButtonBox::wheelEvent(QWheelEvent*  arg__1)
{
