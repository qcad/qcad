...
QtScriptShell_QSplashScreen::QtScriptShell_QSplashScreen(QWidget*  parent, const QPixmap&  pixmap, Qt::WindowFlags  f)
    : QSplashScreen(parent, pixmap, f) {}

QtScriptShell_QSplashScreen::QtScriptShell_QSplashScreen(const QPixmap&  pixmap, Qt::WindowFlags  f)
...
{
    QScriptValue _q_function = __qtscript_self.property("drawContents");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("drawContents") & QScriptValue::QObjectMember)) {
...
bool  QtScriptShell_QSplashScreen::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
bool  QtScriptShell_QSplashScreen::hasHeightForWidth() const
{
...
void QtScriptShell_QSplashScreen::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QSplashScreen::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintDevice*  QtScriptShell_QSplashScreen::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QSplashScreen::sharedPainter() const
{
