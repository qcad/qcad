#ifndef QTSCRIPTSHELL_QSTATUSBAR_H
#define QTSCRIPTSHELL_QSTATUSBAR_H
...
class QtScriptShell_QStatusBar : public QStatusBar
{
public:
    QtScriptShell_QStatusBar(QWidget*  parent = 0);
...
#endif // QTSCRIPTSHELL_QSTATUSBAR_H
