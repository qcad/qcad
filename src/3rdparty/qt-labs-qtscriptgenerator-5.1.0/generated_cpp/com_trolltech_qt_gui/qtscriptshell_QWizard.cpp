...
QtScriptShell_QWizard::QtScriptShell_QWizard(QWidget*  parent, Qt::WindowFlags  flags)
...
bool  QtScriptShell_QWizard::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
int  QtScriptShell_QWizard::exec()
{
...
bool  QtScriptShell_QWizard::hasHeightForWidth() const
{
...
void QtScriptShell_QWizard::initPainter(QPainter*  painter) const
{
...
bool  QtScriptShell_QWizard::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
void QtScriptShell_QWizard::open()
{
...
QPaintDevice*  QtScriptShell_QWizard::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QWizard::sharedPainter() const
{
...
{
    QScriptValue _q_function = __qtscript_self.property("validateCurrentPage");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("validateCurrentPage") & QScriptValue::QObjectMember)) {
