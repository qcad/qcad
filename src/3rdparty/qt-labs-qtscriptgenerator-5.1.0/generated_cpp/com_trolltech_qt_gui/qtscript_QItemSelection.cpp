...
static QScriptValue qtscript_QItemSelection_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    if (context->argumentCount() == 1) {
        ...
        const QItemSelectionRange& _q_result = _q_self->at(_q_arg0);
    ...
    if (context->argumentCount() == 0) {
        const QItemSelectionRange& _q_result = _q_self->back();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 9:
    if (context->argumentCount() == 0) {
        const QItemSelectionRange& _q_result = _q_self->first();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 10:
    if (context->argumentCount() == 0) {
        const QItemSelectionRange& _q_result = _q_self->front();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 15:
    if (context->argumentCount() == 0) {
        const QItemSelectionRange& _q_result = _q_self->last();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
