...
static QScriptValue qtscript_QPaintEngine_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    if (context->argumentCount() == 2) {
        if (qscriptvalue_cast<const QLine*>(context->argument(0))
            && context->argument(1).isNumber()) {
            const QLine* _q_arg0 = qscriptvalue_cast<const QLine*>(context->argument(0));
            int _q_arg1 = context->argument(1).toInt32();
            _q_self->drawLines(_q_arg0, _q_arg1);
            return context->engine()->undefinedValue();
        } else if (qscriptvalue_cast<const QLineF*>(context->argument(0))
            && context->argument(1).isNumber()) {
            const QLineF* _q_arg0 = qscriptvalue_cast<const QLineF*>(context->argument(0));
            int _q_arg1 = context->argument(1).toInt32();
            _q_self->drawLines(_q_arg0, _q_arg1);
            return context->engine()->undefinedValue();
        }
    ...
    case 8:
    if (context->argumentCount() == 2) {
        if (qscriptvalue_cast<const QPoint*>(context->argument(0))
            && context->argument(1).isNumber()) {
            const QPoint* _q_arg0 = qscriptvalue_cast<const QPoint*>(context->argument(0));
            int _q_arg1 = context->argument(1).toInt32();
            _q_self->drawPoints(_q_arg0, _q_arg1);
            return context->engine()->undefinedValue();
        } else if (qscriptvalue_cast<const QPointF*>(context->argument(0))
            && context->argument(1).isNumber()) {
            const QPointF* _q_arg0 = qscriptvalue_cast<const QPointF*>(context->argument(0));
            int _q_arg1 = context->argument(1).toInt32();
            _q_self->drawPoints(_q_arg0, _q_arg1);
            return context->engine()->undefinedValue();
        }
    ...
    case 10:
    if (context->argumentCount() == 2) {
        if (qscriptvalue_cast<const QRect*>(context->argument(0))
            && context->argument(1).isNumber()) {
            const QRect* _q_arg0 = qscriptvalue_cast<const QRect*>(context->argument(0));
            int _q_arg1 = context->argument(1).toInt32();
            _q_self->drawRects(_q_arg0, _q_arg1);
            return context->engine()->undefinedValue();
        } else if (qscriptvalue_cast<const QRectF*>(context->argument(0))
            && context->argument(1).isNumber()) {
            const QRectF* _q_arg0 = qscriptvalue_cast<const QRectF*>(context->argument(0));
            int _q_arg1 = context->argument(1).toInt32();
            _q_self->drawRects(_q_arg0, _q_arg1);
            return context->engine()->undefinedValue();
        }
