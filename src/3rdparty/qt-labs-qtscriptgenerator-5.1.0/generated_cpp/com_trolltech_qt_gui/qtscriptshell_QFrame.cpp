...
QtScriptShell_QFrame::QtScriptShell_QFrame(QWidget*  parent, Qt::WindowFlags  f)
    : QFrame(parent, f) {}

QtScriptShell_QFrame::~QtScriptShell_QFrame() {}

void QtScriptShell_QFrame::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QFrame::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QFrame::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QFrame::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QFrame::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QFrame::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QFrame::devType() const
{
...
void QtScriptShell_QFrame::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QFrame::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QFrame::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QFrame::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QFrame::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QFrame::event(QEvent*  e)
{
...
bool  QtScriptShell_QFrame::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QFrame::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QFrame::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QFrame::focusOutEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QFrame::hasHeightForWidth() const
{
...
int  QtScriptShell_QFrame::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QFrame::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QFrame::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_QFrame::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QFrame::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QFrame::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QFrame::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QFrame::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QFrame::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_QFrame::minimumSizeHint() const
{
...
void QtScriptShell_QFrame::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QFrame::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QFrame::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QFrame::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QFrame::moveEvent(QMoveEvent*  arg__1)
{
...
bool  QtScriptShell_QFrame::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
...
QPaintEngine*  QtScriptShell_QFrame::paintEngine() const
{
...
void QtScriptShell_QFrame::paintEvent(QPaintEvent*  arg__1)
{
...
QPaintDevice*  QtScriptShell_QFrame::redirected(QPoint*  offset) const
{
...
void QtScriptShell_QFrame::resizeEvent(QResizeEvent*  arg__1)
{
...
QPainter*  QtScriptShell_QFrame::sharedPainter() const
{
...
void QtScriptShell_QFrame::showEvent(QShowEvent*  arg__1)
{
...
void QtScriptShell_QFrame::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QFrame::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QFrame::wheelEvent(QWheelEvent*  arg__1)
{
