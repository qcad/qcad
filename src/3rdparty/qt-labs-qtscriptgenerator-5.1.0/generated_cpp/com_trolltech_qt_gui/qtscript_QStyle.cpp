...
static QScriptValue qtscript_QStyle_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    if (context->argumentCount() == 3) {
        ...
        const QStyleOptionComplex* _q_arg1 = qscriptvalue_cast<const QStyleOptionComplex*>(context->argument(1));
    ...
    if (context->argumentCount() == 4) {
        ...
        const QStyleOptionComplex* _q_arg1 = qscriptvalue_cast<const QStyleOptionComplex*>(context->argument(1));
        QPainter* _q_arg2 = qscriptvalue_cast<QPainter*>(context->argument(2));
        const QWidget* _q_arg3 = qscriptvalue_cast<const QWidget*>(context->argument(3));
    ...
    if (context->argumentCount() == 3) {
        ...
        const QStyleOption* _q_arg1 = qscriptvalue_cast<const QStyleOption*>(context->argument(1));
        QPainter* _q_arg2 = qscriptvalue_cast<QPainter*>(context->argument(2));
    ...
    if (context->argumentCount() == 3) {
        ...
        const QStyleOption* _q_arg2 = qscriptvalue_cast<const QStyleOption*>(context->argument(2));
    ...
    if (context->argumentCount() == 4) {
        ...
        QSizePolicy::ControlType _q_arg1 = qscriptvalue_cast<QSizePolicy::ControlType>(context->argument(1));
        Qt::Orientation _q_arg2 = qscriptvalue_cast<Qt::Orientation>(context->argument(2));
        const QStyleOption* _q_arg3 = qscriptvalue_cast<const QStyleOption*>(context->argument(3));
    ...
    if (context->argumentCount() == 5) {
        ...
        Qt::Orientation _q_arg2 = qscriptvalue_cast<Qt::Orientation>(context->argument(2));
        const QStyleOption* _q_arg3 = qscriptvalue_cast<const QStyleOption*>(context->argument(3));
        const QWidget* _q_arg4 = qscriptvalue_cast<const QWidget*>(context->argument(4));
    ...
    if (context->argumentCount() == 3) {
        QStyle::PixelMetric _q_arg0 = qscriptvalue_cast<QStyle::PixelMetric>(context->argument(0));
        const QStyleOption* _q_arg1 = qscriptvalue_cast<const QStyleOption*>(context->argument(1));
        const QWidget* _q_arg2 = qscriptvalue_cast<const QWidget*>(context->argument(2));
    ...
    if (context->argumentCount() == 0) {
        const QStyle* _q_result = const_cast<const QStyle*>(_q_self->proxy());
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
