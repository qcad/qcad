...
void QtScriptShell_QBitmap::initPainter(QPainter*  painter) const
{
...
QPaintDevice*  QtScriptShell_QBitmap::redirected(QPoint*  offset) const
{
...
QPainter*  QtScriptShell_QBitmap::sharedPainter() const
{
