...
class QtScriptShell_SeekSlider : public Phonon::SeekSlider
{
public:
    QtScriptShell_SeekSlider(Phonon::MediaObject*  media, QWidget*  parent = 0);
    QtScriptShell_SeekSlider(QWidget*  parent = 0);
...
#endif // QTSCRIPTSHELL_SEEKSLIDER_H
