#include "qtscriptshell_SeekSlider.h"
...
QtScriptShell_SeekSlider::QtScriptShell_SeekSlider(Phonon::MediaObject*  media, QWidget*  parent)
    : Phonon::SeekSlider(media, parent) {}

QtScriptShell_SeekSlider::QtScriptShell_SeekSlider(QWidget*  parent)
    : Phonon::SeekSlider(parent) {}

QtScriptShell_SeekSlider::~QtScriptShell_SeekSlider() {}

void QtScriptShell_SeekSlider::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_SeekSlider::devType() const
{
...
void QtScriptShell_SeekSlider::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_SeekSlider::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_SeekSlider::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_SeekSlider::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_SeekSlider::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_SeekSlider::focusOutEvent(QFocusEvent*  arg__1)
{
...
int  QtScriptShell_SeekSlider::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_SeekSlider::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_SeekSlider::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_SeekSlider::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::languageChange()
{
...
void QtScriptShell_SeekSlider::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_SeekSlider::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_SeekSlider::minimumSizeHint() const
{
...
void QtScriptShell_SeekSlider::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_SeekSlider::paintEngine() const
{
...
void QtScriptShell_SeekSlider::paintEvent(QPaintEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::resizeEvent(QResizeEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::showEvent(QShowEvent*  arg__1)
{
...
QSize  QtScriptShell_SeekSlider::sizeHint() const
{
...
void QtScriptShell_SeekSlider::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_SeekSlider::wheelEvent(QWheelEvent*  arg__1)
{
