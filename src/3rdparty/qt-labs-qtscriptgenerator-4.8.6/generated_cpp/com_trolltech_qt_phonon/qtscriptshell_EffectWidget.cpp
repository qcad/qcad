...
QtScriptShell_EffectWidget::QtScriptShell_EffectWidget(Phonon::Effect*  effect, QWidget*  parent)
    : Phonon::EffectWidget(effect, parent) {}

QtScriptShell_EffectWidget::~QtScriptShell_EffectWidget() {}

void QtScriptShell_EffectWidget::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_EffectWidget::devType() const
{
...
void QtScriptShell_EffectWidget::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_EffectWidget::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_EffectWidget::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_EffectWidget::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_EffectWidget::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_EffectWidget::focusOutEvent(QFocusEvent*  arg__1)
{
...
int  QtScriptShell_EffectWidget::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_EffectWidget::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_EffectWidget::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_EffectWidget::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::languageChange()
{
...
void QtScriptShell_EffectWidget::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_EffectWidget::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_EffectWidget::minimumSizeHint() const
{
...
void QtScriptShell_EffectWidget::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_EffectWidget::paintEngine() const
{
...
void QtScriptShell_EffectWidget::paintEvent(QPaintEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::resizeEvent(QResizeEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::showEvent(QShowEvent*  arg__1)
{
...
QSize  QtScriptShell_EffectWidget::sizeHint() const
{
...
void QtScriptShell_EffectWidget::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_EffectWidget::wheelEvent(QWheelEvent*  arg__1)
{
