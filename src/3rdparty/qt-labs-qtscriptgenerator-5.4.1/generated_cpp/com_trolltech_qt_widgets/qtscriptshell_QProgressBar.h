#ifndef QTSCRIPTSHELL_QPROGRESSBAR_H
#define QTSCRIPTSHELL_QPROGRESSBAR_H
...
class QtScriptShell_QProgressBar : public QProgressBar
{
public:
    QtScriptShell_QProgressBar(QWidget*  parent = 0);
...
#endif // QTSCRIPTSHELL_QPROGRESSBAR_H
