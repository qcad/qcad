...
static const QtBindingCreator qtscript_com_trolltech_qt_widgets_class_functions[] = {
    qtscript_create_QPlainTextDocumentLayout_class
    , qtscript_create_QStyleOption_class
    , qtscript_create_QStyleFactory_class
    , qtscript_create_QItemSelection_class
    , qtscript_create_QListWidgetItem_class
    , qtscript_create_QTableWidgetSelectionRange_class
    ...
    , qtscript_create_QUndoCommand_class
    , qtscript_create_QWhatsThis_class
    , qtscript_create_QFileIconProvider_class
    , qtscript_create_QToolTip_class
    , qtscript_create_QGraphicsItem_class
    , qtscript_create_QLayoutItem_class
    , qtscript_create_QGraphicsLayoutItem_class
    , qtscript_create_QItemSelectionRange_class
    , qtscript_create_QItemEditorFactory_class
    , qtscript_create_QTableWidgetItem_class
    , qtscript_create_QShortcut_class
    , qtscript_create_QStylePainter_class
    , qtscript_create_QGraphicsEffect_class
    , qtscript_create_QGraphicsObject_class
    , qtscript_create_QStyleHintReturnVariant_class
    , qtscript_create_QUndoStack_class
    , qtscript_create_QStylePlugin_class
    , qtscript_create_QLayout_class
    , qtscript_create_QDataWidgetMapper_class
    , qtscript_create_QStyle_class
    ...
    , qtscript_create_QStyleOptionTabWidgetFrame_class
    , qtscript_create_QStyleOptionTab_class
    , qtscript_create_QStyleOptionRubberBand_class
    , qtscript_create_QWidgetItem_class
    , qtscript_create_QStyleOptionToolBox_class
    , qtscript_create_QStyleOptionHeader_class
    , qtscript_create_QActionGroup_class
    , qtscript_create_QStyleOptionMenuItem_class
    , qtscript_create_QStyleOptionFocusRect_class
    , qtscript_create_QGesture_class
    , qtscript_create_QSpacerItem_class
    , qtscript_create_QGraphicsAnchor_class
    , qtscript_create_QSessionManager_class
    , qtscript_create_QSystemTrayIcon_class
    , qtscript_create_QStyleOptionDockWidget_class
    , qtscript_create_QStyleOptionProgressBar_class
    , qtscript_create_QStyleOptionComplex_class
    , qtscript_create_QStyleHintReturnMask_class
    , qtscript_create_QAbstractGraphicsShapeItem_class
    , qtscript_create_QAction_class
    , qtscript_create_QGraphicsLayout_class
    , qtscript_create_QItemSelectionModel_class
    , qtscript_create_QStyleOptionButton_class
    , qtscript_create_QStyleOptionGraphicsItem_class
    , qtscript_create_QGraphicsItemGroup_class
    , qtscript_create_QStyleOptionViewItem_class
    ...
    , qtscript_create_QGraphicsScene_class
    , qtscript_create_QMenuBar_class
    , qtscript_create_QAbstractSpinBox_class
    , qtscript_create_QAbstractSlider_class
    , qtscript_create_QGraphicsSimpleTextItem_class
    ...
    , qtscript_create_QFocusFrame_class
    , qtscript_create_QGraphicsSceneResizeEvent_class
    , qtscript_create_QGraphicsRotation_class
    , qtscript_create_QMdiSubWindow_class
    , qtscript_create_QStatusBar_class
    , qtscript_create_QGraphicsRectItem_class
    , qtscript_create_QProgressBar_class
    , qtscript_create_QCalendarWidget_class
    , qtscript_create_QGraphicsAnchorLayout_class
    , qtscript_create_QStandardItemModel_class
    , qtscript_create_QWidgetAction_class
    , qtscript_create_QSplashScreen_class
    , qtscript_create_QMenu_class
    , qtscript_create_QWizardPage_class
    , qtscript_create_QComboBox_class
    , qtscript_create_QGraphicsSceneHelpEvent_class
    , qtscript_create_QAbstractButton_class
    , qtscript_create_QGraphicsColorizeEffect_class
    , qtscript_create_QGraphicsPathItem_class
    , qtscript_create_QStyleOptionToolButton_class
    , qtscript_create_QStyleOptionGroupBox_class
    , qtscript_create_QGraphicsOpacityEffect_class
    , qtscript_create_QCommonStyle_class
    , qtscript_create_QSplitterHandle_class
    , qtscript_create_QGroupBox_class
    , qtscript_create_QTabWidget_class
    , qtscript_create_QDialogButtonBox_class
    , qtscript_create_QItemDelegate_class
    , qtscript_create_QSwipeGesture_class
    , qtscript_create_QTabBar_class
    , qtscript_create_QMainWindow_class
    , qtscript_create_QLineEdit_class
    , qtscript_create_QStyleOptionTitleBar_class
    , qtscript_create_QGraphicsGridLayout_class
    , qtscript_create_QGraphicsBlurEffect_class
    , qtscript_create_QFormLayout_class
    , qtscript_create_QGraphicsWidget_class
    , qtscript_create_QStyledItemDelegate_class
    , qtscript_create_QGraphicsSceneMoveEvent_class
    , qtscript_create_QStyleOptionSpinBox_class
    , qtscript_create_QGraphicsLinearLayout_class
    , qtscript_create_QRubberBand_class
    , qtscript_create_QGraphicsSceneHoverEvent_class
    , qtscript_create_QSizeGrip_class
    , qtscript_create_QGraphicsSceneContextMenuEvent_class
    , qtscript_create_QStyleOptionSizeGrip_class
    , qtscript_create_QBoxLayout_class
    , qtscript_create_QGraphicsScale_class
    , qtscript_create_QGraphicsEllipseItem_class
    , qtscript_create_QTouchEvent_class
    , qtscript_create_QStyleOptionSlider_class
    , qtscript_create_QGraphicsDropShadowEffect_class
    ...
    , qtscript_create_QGraphicsPolygonItem_class
    , qtscript_create_QProgressDialog_class
    ...
    , qtscript_create_QPushButton_class
    , qtscript_create_QWizard_class
    , qtscript_create_QLabel_class
    , qtscript_create_QDoubleSpinBox_class
    , qtscript_create_QSpinBox_class
    , qtscript_create_QFileDialog_class
    , qtscript_create_QDateTimeEdit_class
    , qtscript_create_QMessageBox_class
    , qtscript_create_QScrollBar_class
    , qtscript_create_QStringListModel_class
    , qtscript_create_QStackedWidget_class
    , qtscript_create_QDial_class
    ...
    , qtscript_create_QRadioButton_class
    , qtscript_create_QCheckBox_class
    , qtscript_create_QDateEdit_class
    , qtscript_create_QTextEdit_class
    , qtscript_create_QAbstractItemView_class
    , qtscript_create_QTimeEdit_class
    , qtscript_create_QCommandLinkButton_class
    , qtscript_create_QGraphicsView_class
    , qtscript_create_QPlainTextEdit_class
    , qtscript_create_QScrollArea_class
    , qtscript_create_QMdiArea_class
    , qtscript_create_QTextBrowser_class
    , qtscript_create_QTreeView_class
    , qtscript_create_QColumnView_class
    , qtscript_create_QListView_class
    , qtscript_create_QHeaderView_class
    , qtscript_create_QTableView_class
    , qtscript_create_QTreeWidget_class
