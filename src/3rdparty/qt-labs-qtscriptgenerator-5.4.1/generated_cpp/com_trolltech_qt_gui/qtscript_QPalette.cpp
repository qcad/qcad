...
static QScriptValue qtscript_QPalette_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->alternateBase();
    ...
    case 1:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->base();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 2:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->brightText();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    if (context->argumentCount() == 1) {
        ...
        const QBrush& _q_result = _q_self->brush(_q_arg0);
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    if (context->argumentCount() == 2) {
        ...
        const QBrush& _q_result = _q_self->brush(_q_arg0, _q_arg1);
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 4:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->button();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 5:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->buttonText();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    if (context->argumentCount() == 1) {
        QPalette::ColorRole _q_arg0 = qscriptvalue_cast<QPalette::ColorRole>(context->argument(0));
        const QColor& _q_result = _q_self->color(_q_arg0);
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    if (context->argumentCount() == 2) {
        QPalette::ColorGroup _q_arg0 = qscriptvalue_cast<QPalette::ColorGroup>(context->argument(0));
        QPalette::ColorRole _q_arg1 = qscriptvalue_cast<QPalette::ColorRole>(context->argument(1));
        const QColor& _q_result = _q_self->color(_q_arg0, _q_arg1);
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 9:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->dark();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 10:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->highlight();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 11:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->highlightedText();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 15:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->light();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 16:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->link();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 17:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->linkVisited();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 18:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->mid();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 19:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->midlight();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 26:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->shadow();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 28:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->text();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 29:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->toolTipBase();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 30:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->toolTipText();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 31:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->window();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
    ...
    case 32:
    if (context->argumentCount() == 0) {
        const QBrush& _q_result = _q_self->windowText();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
