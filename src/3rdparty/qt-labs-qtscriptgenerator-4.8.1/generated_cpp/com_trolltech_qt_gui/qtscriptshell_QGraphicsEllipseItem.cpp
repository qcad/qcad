...
QtScriptShell_QGraphicsEllipseItem::QtScriptShell_QGraphicsEllipseItem(QGraphicsItem*  parent, QGraphicsScene*  scene)
    : QGraphicsEllipseItem(parent, scene) {}

QtScriptShell_QGraphicsEllipseItem::QtScriptShell_QGraphicsEllipseItem(const QRectF&  rect, QGraphicsItem*  parent, QGraphicsScene*  scene)
    : QGraphicsEllipseItem(rect, parent, scene) {}

QtScriptShell_QGraphicsEllipseItem::QtScriptShell_QGraphicsEllipseItem(qreal  x, qreal  y, qreal  w, qreal  h, QGraphicsItem*  parent, QGraphicsScene*  scene)
