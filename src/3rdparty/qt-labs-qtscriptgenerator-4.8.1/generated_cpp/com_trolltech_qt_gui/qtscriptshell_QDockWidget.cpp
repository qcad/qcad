...
QtScriptShell_QDockWidget::QtScriptShell_QDockWidget(QWidget*  parent, Qt::WindowFlags  flags)
    : QDockWidget(parent, flags) {}

QtScriptShell_QDockWidget::QtScriptShell_QDockWidget(const QString&  title, QWidget*  parent, Qt::WindowFlags  flags)
    : QDockWidget(title, parent, flags) {}

QtScriptShell_QDockWidget::~QtScriptShell_QDockWidget() {}

void QtScriptShell_QDockWidget::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::changeEvent(QEvent*  event)
{
...
void QtScriptShell_QDockWidget::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::closeEvent(QCloseEvent*  event)
{
...
void QtScriptShell_QDockWidget::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QDockWidget::devType() const
{
...
void QtScriptShell_QDockWidget::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QDockWidget::event(QEvent*  event)
{
...
bool  QtScriptShell_QDockWidget::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QDockWidget::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QDockWidget::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QDockWidget::focusOutEvent(QFocusEvent*  arg__1)
{
...
int  QtScriptShell_QDockWidget::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QDockWidget::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QDockWidget::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QDockWidget::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::languageChange()
{
...
void QtScriptShell_QDockWidget::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QDockWidget::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_QDockWidget::minimumSizeHint() const
{
...
void QtScriptShell_QDockWidget::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_QDockWidget::paintEngine() const
{
...
void QtScriptShell_QDockWidget::paintEvent(QPaintEvent*  event)
{
...
void QtScriptShell_QDockWidget::resizeEvent(QResizeEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::showEvent(QShowEvent*  arg__1)
{
...
QSize  QtScriptShell_QDockWidget::sizeHint() const
{
...
void QtScriptShell_QDockWidget::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QDockWidget::wheelEvent(QWheelEvent*  arg__1)
{
