...
QtScriptShell_QWidget::QtScriptShell_QWidget(QWidget*  parent, Qt::WindowFlags  f)
    : QWidget(parent, f) {}

QtScriptShell_QWidget::~QtScriptShell_QWidget() {}

void QtScriptShell_QWidget::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QWidget::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QWidget::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QWidget::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QWidget::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QWidget::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QWidget::devType() const
{
...
void QtScriptShell_QWidget::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QWidget::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QWidget::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QWidget::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QWidget::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QWidget::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QWidget::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QWidget::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QWidget::focusOutEvent(QFocusEvent*  arg__1)
{
...
int  QtScriptShell_QWidget::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QWidget::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QWidget::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QWidget::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QWidget::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QWidget::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QWidget::languageChange()
{
...
void QtScriptShell_QWidget::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QWidget::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_QWidget::minimumSizeHint() const
{
...
void QtScriptShell_QWidget::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QWidget::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QWidget::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QWidget::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QWidget::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_QWidget::paintEngine() const
{
...
void QtScriptShell_QWidget::paintEvent(QPaintEvent*  arg__1)
{
...
void QtScriptShell_QWidget::resizeEvent(QResizeEvent*  arg__1)
{
...
void QtScriptShell_QWidget::showEvent(QShowEvent*  arg__1)
{
...
QSize  QtScriptShell_QWidget::sizeHint() const
{
...
void QtScriptShell_QWidget::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QWidget::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QWidget::wheelEvent(QWheelEvent*  arg__1)
{
