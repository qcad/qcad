...
QtScriptShell_VolumeSlider::QtScriptShell_VolumeSlider(Phonon::AudioOutput*  arg__1, QWidget*  parent)
    : Phonon::VolumeSlider(arg__1, parent) {}

QtScriptShell_VolumeSlider::QtScriptShell_VolumeSlider(QWidget*  parent)
    : Phonon::VolumeSlider(parent) {}

QtScriptShell_VolumeSlider::~QtScriptShell_VolumeSlider() {}

void QtScriptShell_VolumeSlider::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_VolumeSlider::devType() const
{
...
void QtScriptShell_VolumeSlider::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_VolumeSlider::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_VolumeSlider::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_VolumeSlider::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_VolumeSlider::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_VolumeSlider::focusOutEvent(QFocusEvent*  arg__1)
{
...
int  QtScriptShell_VolumeSlider::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_VolumeSlider::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_VolumeSlider::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_VolumeSlider::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::languageChange()
{
...
void QtScriptShell_VolumeSlider::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_VolumeSlider::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_VolumeSlider::minimumSizeHint() const
{
...
void QtScriptShell_VolumeSlider::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_VolumeSlider::paintEngine() const
{
...
void QtScriptShell_VolumeSlider::paintEvent(QPaintEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::resizeEvent(QResizeEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::showEvent(QShowEvent*  arg__1)
{
...
QSize  QtScriptShell_VolumeSlider::sizeHint() const
{
...
void QtScriptShell_VolumeSlider::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_VolumeSlider::wheelEvent(QWheelEvent*  arg__1)
{
