...
QtScriptShell_VideoWidget::QtScriptShell_VideoWidget(QWidget*  parent)
    : Phonon::VideoWidget(parent) {}

QtScriptShell_VideoWidget::~QtScriptShell_VideoWidget() {}

void QtScriptShell_VideoWidget::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_VideoWidget::devType() const
{
...
void QtScriptShell_VideoWidget::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_VideoWidget::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_VideoWidget::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_VideoWidget::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_VideoWidget::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_VideoWidget::focusOutEvent(QFocusEvent*  arg__1)
{
...
int  QtScriptShell_VideoWidget::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_VideoWidget::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_VideoWidget::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_VideoWidget::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::languageChange()
{
...
void QtScriptShell_VideoWidget::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_VideoWidget::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_VideoWidget::minimumSizeHint() const
{
...
void QtScriptShell_VideoWidget::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_VideoWidget::paintEngine() const
{
...
void QtScriptShell_VideoWidget::paintEvent(QPaintEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::resizeEvent(QResizeEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::showEvent(QShowEvent*  arg__1)
{
...
QSize  QtScriptShell_VideoWidget::sizeHint() const
{
...
void QtScriptShell_VideoWidget::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_VideoWidget::wheelEvent(QWheelEvent*  arg__1)
{
