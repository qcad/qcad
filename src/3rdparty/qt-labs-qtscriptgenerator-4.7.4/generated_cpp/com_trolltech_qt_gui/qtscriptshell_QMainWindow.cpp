...
{
    qDebug() << "QtScriptShell_QMainWindow::mousePressEvent";
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        qDebug() << "QtScriptShell_QMainWindow::mousePressEvent: calling base class";
        QMainWindow::mousePressEvent(arg__1);
        qDebug() << "QtScriptShell_QMainWindow::mousePressEvent: calling base class: done";
    } else {
        qDebug() << "QtScriptShell_QMainWindow::mousePressEvent: calling JS";
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
            << qScriptValueFromValue(_q_engine, arg__1));
        qDebug() << "QtScriptShell_QMainWindow::mousePressEvent: calling JS: done";
    }
    qDebug() << "QtScriptShell_QMainWindow::mousePressEvent: done";
}
