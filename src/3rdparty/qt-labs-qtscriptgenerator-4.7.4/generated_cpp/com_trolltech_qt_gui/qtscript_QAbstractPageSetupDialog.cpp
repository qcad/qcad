...
static const int qtscript_QAbstractPageSetupDialog_function_lengths[] = {
    2
    // static
    // prototype
    , 0
...
QScriptValue qtscript_create_QAbstractPageSetupDialog_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 2; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QAbstractPageSetupDialog_prototype_call, qtscript_QAbstractPageSetupDialog_function_lengths[i+1]);
    ...
    QScriptValue ctor = engine->newFunction(qtscript_QAbstractPageSetupDialog_static_call, proto, qtscript_QAbstractPageSetupDialog_function_lengths[0]);
