...
QtScriptShell_VideoPlayer::QtScriptShell_VideoPlayer(Phonon::Category  category, QWidget*  parent)
    : Phonon::VideoPlayer(category, parent) {}

QtScriptShell_VideoPlayer::QtScriptShell_VideoPlayer(QWidget*  parent)
    : Phonon::VideoPlayer(parent) {}

QtScriptShell_VideoPlayer::~QtScriptShell_VideoPlayer() {}

void QtScriptShell_VideoPlayer::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_VideoPlayer::devType() const
{
...
void QtScriptShell_VideoPlayer::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_VideoPlayer::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_VideoPlayer::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_VideoPlayer::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_VideoPlayer::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_VideoPlayer::focusOutEvent(QFocusEvent*  arg__1)
{
...
int  QtScriptShell_VideoPlayer::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_VideoPlayer::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_VideoPlayer::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_VideoPlayer::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::languageChange()
{
...
void QtScriptShell_VideoPlayer::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_VideoPlayer::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_VideoPlayer::minimumSizeHint() const
{
...
void QtScriptShell_VideoPlayer::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_VideoPlayer::paintEngine() const
{
...
void QtScriptShell_VideoPlayer::paintEvent(QPaintEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::resizeEvent(QResizeEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::showEvent(QShowEvent*  arg__1)
{
...
QSize  QtScriptShell_VideoPlayer::sizeHint() const
{
...
void QtScriptShell_VideoPlayer::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_VideoPlayer::wheelEvent(QWheelEvent*  arg__1)
{
