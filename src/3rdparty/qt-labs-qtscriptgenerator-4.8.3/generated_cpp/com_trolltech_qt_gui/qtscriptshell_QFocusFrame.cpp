...
QtScriptShell_QFocusFrame::QtScriptShell_QFocusFrame(QWidget*  parent)
    : QFocusFrame(parent) {}

QtScriptShell_QFocusFrame::~QtScriptShell_QFocusFrame() {}

void QtScriptShell_QFocusFrame::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QFocusFrame::devType() const
{
...
void QtScriptShell_QFocusFrame::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::dropEvent(QDropEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::enterEvent(QEvent*  arg__1)
{
...
bool  QtScriptShell_QFocusFrame::event(QEvent*  e)
{
...
bool  QtScriptShell_QFocusFrame::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QFocusFrame::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QFocusFrame::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QFocusFrame::focusOutEvent(QFocusEvent*  arg__1)
{
...
int  QtScriptShell_QFocusFrame::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QFocusFrame::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QFocusFrame::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QFocusFrame::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::languageChange()
{
...
void QtScriptShell_QFocusFrame::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QFocusFrame::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_QFocusFrame::minimumSizeHint() const
{
...
void QtScriptShell_QFocusFrame::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_QFocusFrame::paintEngine() const
{
...
void QtScriptShell_QFocusFrame::paintEvent(QPaintEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::resizeEvent(QResizeEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::showEvent(QShowEvent*  arg__1)
{
...
QSize  QtScriptShell_QFocusFrame::sizeHint() const
{
...
void QtScriptShell_QFocusFrame::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QFocusFrame::wheelEvent(QWheelEvent*  arg__1)
{
