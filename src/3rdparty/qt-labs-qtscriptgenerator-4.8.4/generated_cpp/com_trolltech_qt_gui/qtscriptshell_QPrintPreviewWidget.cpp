...
QtScriptShell_QPrintPreviewWidget::QtScriptShell_QPrintPreviewWidget(QPrinter*  printer, QWidget*  parent, Qt::WindowFlags  flags)
    : QPrintPreviewWidget(printer, parent, flags) {}

QtScriptShell_QPrintPreviewWidget::QtScriptShell_QPrintPreviewWidget(QWidget*  parent, Qt::WindowFlags  flags)
    : QPrintPreviewWidget(parent, flags) {}

QtScriptShell_QPrintPreviewWidget::~QtScriptShell_QPrintPreviewWidget() {}

void QtScriptShell_QPrintPreviewWidget::actionEvent(QActionEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::childEvent(QChildEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::closeEvent(QCloseEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::contextMenuEvent(QContextMenuEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::customEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QPrintPreviewWidget::devType() const
{
...
void QtScriptShell_QPrintPreviewWidget::dragEnterEvent(QDragEnterEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::dragLeaveEvent(QDragLeaveEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::dragMoveEvent(QDragMoveEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::dropEvent(QDropEvent*  arg__1)
{
...
bool  QtScriptShell_QPrintPreviewWidget::event(QEvent*  arg__1)
{
...
bool  QtScriptShell_QPrintPreviewWidget::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
...
void QtScriptShell_QPrintPreviewWidget::focusInEvent(QFocusEvent*  arg__1)
{
...
bool  QtScriptShell_QPrintPreviewWidget::focusNextPrevChild(bool  next)
{
...
void QtScriptShell_QPrintPreviewWidget::focusOutEvent(QFocusEvent*  arg__1)
{
...
int  QtScriptShell_QPrintPreviewWidget::heightForWidth(int  arg__1) const
{
...
void QtScriptShell_QPrintPreviewWidget::hideEvent(QHideEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::inputMethodEvent(QInputMethodEvent*  arg__1)
{
...
QVariant  QtScriptShell_QPrintPreviewWidget::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
...
void QtScriptShell_QPrintPreviewWidget::keyPressEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::keyReleaseEvent(QKeyEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::languageChange()
{
...
void QtScriptShell_QPrintPreviewWidget::leaveEvent(QEvent*  arg__1)
{
...
int  QtScriptShell_QPrintPreviewWidget::metric(QPaintDevice::PaintDeviceMetric  arg__1) const
{
...
QSize  QtScriptShell_QPrintPreviewWidget::minimumSizeHint() const
{
...
void QtScriptShell_QPrintPreviewWidget::mouseDoubleClickEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::mouseMoveEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::mousePressEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::mouseReleaseEvent(QMouseEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::moveEvent(QMoveEvent*  arg__1)
{
...
QPaintEngine*  QtScriptShell_QPrintPreviewWidget::paintEngine() const
{
...
void QtScriptShell_QPrintPreviewWidget::paintEvent(QPaintEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::resizeEvent(QResizeEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::showEvent(QShowEvent*  arg__1)
{
...
QSize  QtScriptShell_QPrintPreviewWidget::sizeHint() const
{
...
void QtScriptShell_QPrintPreviewWidget::tabletEvent(QTabletEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::timerEvent(QTimerEvent*  arg__1)
{
...
void QtScriptShell_QPrintPreviewWidget::wheelEvent(QWheelEvent*  arg__1)
{
