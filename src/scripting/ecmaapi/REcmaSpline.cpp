// ***** AUTOGENERATED CODE, DO NOT EDIT *****
        ...
        // includes for base ecma wrapper classes
                 ...
                 void REcmaSpline::init(QScriptEngine& engine, QScriptValue* proto 
    ...
    if( protoCreated ){
     ...
     QScriptValue REcmaSpline::create(QScriptContext* context, QScriptEngine* engine) 
    ...
    QString result;
            ...
            result = QString("RSpline(0x%1)").arg((unsigned long int)self, 0, 16);
