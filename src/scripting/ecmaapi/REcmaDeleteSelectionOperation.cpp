    ...
    // ***** AUTOGENERATED CODE, DO NOT EDIT *****
        ...
        // includes for base ecma wrapper classes
                 ...
                 void REcmaDeleteSelectionOperation::init(QScriptEngine& engine, QScriptValue* proto 
    ...
    if( protoCreated ){
     ...
     QScriptValue REcmaDeleteSelectionOperation::create(QScriptContext* context, QScriptEngine* engine) 
    ...
    a1);
        // return type: RTransaction
         ...
         QScriptValue
        REcmaDeleteSelectionOperation::preview
        (QScriptContext* context, QScriptEngine* engine) 
    ...
    // prepare arguments:
                    ...
                    if( ap1 == NULL ){
                           return REcmaHelper::throwError("RDeleteSelectionOperation: Argument 1 is not of type RExporter*.",
                               context);                    
                    }
                    RExporter& a1 = *ap1;
