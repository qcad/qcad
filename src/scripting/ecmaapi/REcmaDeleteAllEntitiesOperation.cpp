    ...
    if( protoCreated ){
     ...
     QScriptValue REcmaDeleteAllEntitiesOperation::create(QScriptContext* context, QScriptEngine* engine) 
    ...
    a1);
        // return type: RTransaction
         ...
         QScriptValue
        REcmaDeleteAllEntitiesOperation::preview
        (QScriptContext* context, QScriptEngine* engine) 
    ...
    // prepare arguments:
                    ...
                    if( ap1 == NULL ){
                           return REcmaHelper::throwError("RDeleteAllEntitiesOperation: Argument 1 is not of type RExporter*.",
                               context);                    
                    }
                    RExporter& a1 = *ap1;
