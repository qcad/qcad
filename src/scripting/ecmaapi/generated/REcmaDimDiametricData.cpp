// ***** AUTOGENERATED CODE, DO NOT EDIT *****
    ...
    // prepare arguments:
                    ...
                    if( ap0 == NULL ){
                           ...
                           return REcmaHelper::throwError("RDimDiametricData: Argument 0 is not of type RDimensionData* or QSharedPointer<RDimensionData>.",
                               context);
                    }
    ...
    QString cppResult =
        ...
        // return type: QString
         ...
         QScriptValue
        REcmaDimDiametricData::to2D
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaDimDiametricData::to2D", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaDimDiametricData::to2D";
            //QCoreApplication::processEvents();
    ...
    // return type 'void'
            ...
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RDimDiametricData.to2D().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaDimDiametricData::to2D", context, engine);
            return result;
        }
