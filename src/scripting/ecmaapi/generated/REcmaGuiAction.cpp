// ***** AUTOGENERATED CODE, DO NOT EDIT *****
    ...
    a1);
         ...
         QScriptValue
        REcmaGuiAction::setCurrentBlock
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaGuiAction::setCurrentBlock", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaGuiAction::setCurrentBlock";
            //QCoreApplication::processEvents();
    ...
    // return type 'void'
            ...
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RGuiAction.setCurrentBlock().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaGuiAction::setCurrentBlock", context, engine);
            return result;
        }
         QScriptValue
