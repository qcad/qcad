// ***** AUTOGENERATED CODE, DO NOT EDIT *****
        ...
        #ifndef RECMATRANSACTIONLISTENERADAPTER_H
        #define RECMATRANSACTIONLISTENERADAPTER_H
         ...
         */
        class QCADECMAAPI_EXPORT REcmaTransactionListenerAdapter {
    ...
    ;static RTransactionListenerAdapter* getSelf(const QString& fName, QScriptContext* context)
    ;static RTransactionListenerAdapter* getSelfShell(const QString& fName, QScriptContext* context)
