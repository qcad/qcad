    ...
    // type: int, copyable: true
      ...
      void REcmaShellTreeWidget::scrollToData(
                const QString & data, Qt::ItemDataRole role
            ) {
                QScriptEngine* engine = __qtscript_self.engine();
                //REcmaHelper::shellFunctionStart("REcmaShellTreeWidget::scrollToData", engine);
                QScriptValue _q_function = __qtscript_self.property("scrollToData");
                ...
                if (!_q_function.isFunction() || 
                    ...
                    //QString cppSig = "RTreeWidget::scrollToData";
                        ...
                        //REcmaHelper::shellFunctionEnd("REcmaShellTreeWidget::scrollToData", engine);
    ...
    // type: Qt::ItemDataRole, copyable: true
        << qScriptValueFromValue(engine, 
    ...
    // type: QResizeEvent *, copyable: false
      ...
      void REcmaShellTreeWidget::initViewItemOption(
                QStyleOptionViewItem * option
            ) {
                QScriptEngine* engine = __qtscript_self.engine();
                //REcmaHelper::shellFunctionStart("REcmaShellTreeWidget::initViewItemOption", engine);
                QScriptValue _q_function = __qtscript_self.property("initViewItemOption");
                ...
                if (!_q_function.isFunction() || 
                    ...
                    //QString cppSig = "RTreeWidget::initViewItemOption";
                        ...
                        //if (cppSig!="RGraphicsViewQt::event") {
                            _q_function.setData(QScriptValue(engine, prev & 0xFFFF0000));
                        //}
                        RTreeWidget::initViewItemOption(
                            option
                        );
                        ...
                        //REcmaHelper::shellFunctionEnd("REcmaShellTreeWidget::initViewItemOption", engine);
                    ...
                    _q_function.setData(QScriptValue(engine, uint(prev | 0x0000B000)));
                        ...
                        // temporary make protected function scriptable, only from the context of this function call:
                        QScriptValue proto = engine->defaultPrototype(qMetaTypeId<RTreeWidget*>());
                        REcmaHelper::registerFunction(engine, &proto, initViewItemOption, "initViewItemOption");
    ...
    // return type 'void'
         ...
         QScriptValue
        REcmaShellTreeWidget::initViewItemOption
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaShellTreeWidget::initViewItemOption", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaShellTreeWidget::initViewItemOption";
            //QCoreApplication::processEvents();
    ...
    // prepare arguments:
                    ...
                    // argument is pointer
                    QStyleOptionViewItem * a0 = NULL;

                    a0 = 
                        REcmaHelper::scriptValueTo<QStyleOptionViewItem >(
                            context->argument(0)
                        );
                    
                    if (a0==NULL && 
                        !context->argument(0).isNull()) {
                        return REcmaHelper::throwError("RTreeWidget: Argument 0 is not of type QStyleOptionViewItem *QStyleOptionViewItem *.", context);                    
                    }
    ...
    // return type 'void'
               ...
               self->RTreeWidget::initViewItemOption(a0);
    } else


        
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RTreeWidget.initViewItemOption().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaShellTreeWidget::initViewItemOption", context, engine);
            return result;
        }
