    ...
    // type: bool, copyable: true
      ...
      void REcmaShellRestrictAngleLength::setRepeatAngle(
                bool on
            ) {
                QScriptEngine* engine = __qtscript_self.engine();
                //REcmaHelper::shellFunctionStart("REcmaShellRestrictAngleLength::setRepeatAngle", engine);
                QScriptValue _q_function = __qtscript_self.property("setRepeatAngle");
                ...
                if (!_q_function.isFunction() || 
                    ...
                    //QString cppSig = "RRestrictAngleLength::setRepeatAngle";
                        ...
                        //if (cppSig!="RGraphicsViewQt::event") {
                            _q_function.setData(QScriptValue(engine, prev & 0xFFFF0000));
                        //}
                        RRestrictAngleLength::setRepeatAngle(
                            on
                        );
                        ...
                        //REcmaHelper::shellFunctionEnd("REcmaShellRestrictAngleLength::setRepeatAngle", engine);
    ...
    // type: bool, copyable: true
      ...
      void REcmaShellRestrictAngleLength::setRepeatLength(
                bool on
            ) {
                QScriptEngine* engine = __qtscript_self.engine();
                //REcmaHelper::shellFunctionStart("REcmaShellRestrictAngleLength::setRepeatLength", engine);
                QScriptValue _q_function = __qtscript_self.property("setRepeatLength");
                ...
                if (!_q_function.isFunction() || 
                    ...
                    //QString cppSig = "RRestrictAngleLength::setRepeatLength";
                        ...
                        //if (cppSig!="RGraphicsViewQt::event") {
                            _q_function.setData(QScriptValue(engine, prev & 0xFFFF0000));
                        //}
                        RRestrictAngleLength::setRepeatLength(
                            on
                        );
                        ...
                        //REcmaHelper::shellFunctionEnd("REcmaShellRestrictAngleLength::setRepeatLength", engine);
