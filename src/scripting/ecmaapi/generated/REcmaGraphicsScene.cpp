// ***** AUTOGENERATED CODE, DO NOT EDIT *****
    ...
    // methods:
            ...
            REcmaHelper::registerFunction(&engine, proto, updateDraftStatus, "updateDraftStatus");
            
            REcmaHelper::registerFunction(&engine, proto, hasDraftView, "hasDraftView");
            
            REcmaHelper::registerFunction(&engine, proto, hasNormalView, "hasNormalView");
    ...
    QMultiMap < REntity::Id , RVector > & cppResult =
        ...
        // return type: QMultiMap < REntity::Id , RVector > &
         ...
         QScriptValue
        REcmaGraphicsScene::updateDraftStatus
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaGraphicsScene::updateDraftStatus", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaGraphicsScene::updateDraftStatus";
            //QCoreApplication::processEvents();
            ...
            QScriptValue result = engine->undefinedValue();
                    ...
                    // public function: can be called from ECMA wrapper of ECMA shell:
                    RGraphicsScene* self = 
                        getSelf("updateDraftStatus", context);
    ...
    // return type 'void'
               ...
               self->updateDraftStatus(a0);
    } else


        
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RGraphicsScene.updateDraftStatus().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaGraphicsScene::updateDraftStatus", context, engine);
            return result;
        }
         QScriptValue
        REcmaGraphicsScene::hasDraftView
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaGraphicsScene::hasDraftView", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaGraphicsScene::hasDraftView";
            //QCoreApplication::processEvents();
    ...
    bool cppResult =
        ...
        // return type: bool
            ...
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RGraphicsScene.hasDraftView().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaGraphicsScene::hasDraftView", context, engine);
            return result;
        }
         QScriptValue
        REcmaGraphicsScene::hasNormalView
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaGraphicsScene::hasNormalView", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaGraphicsScene::hasNormalView";
            //QCoreApplication::processEvents();
    ...
    bool cppResult =
        ...
        // return type: bool
            ...
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RGraphicsScene.hasNormalView().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaGraphicsScene::hasNormalView", context, engine);
            return result;
        }
         QScriptValue
