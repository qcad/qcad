// ***** AUTOGENERATED CODE, DO NOT EDIT *****
        ...
        // includes for base ecma wrapper classes
         void REcmaDxfServices::init(QScriptEngine& engine, QScriptValue* proto 
    ...
    // static methods:
            ...
            REcmaHelper::registerFunction(&engine, &ctor, attributesToColor, "attributesToColor");
    ...
    if( protoCreated ){
     ...
     QScriptValue REcmaDxfServices::create(QScriptContext* context, QScriptEngine* engine) 
    ...
    a3);
         ...
         QScriptValue
        REcmaDxfServices::attributesToColor
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaDxfServices::attributesToColor", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaDxfServices::attributesToColor";
            //QCoreApplication::processEvents();
    ...
    a2);
        // return type: RColor
            ...
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RDxfServices.attributesToColor().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaDxfServices::attributesToColor", context, engine);
            return result;
        }
         QScriptValue
