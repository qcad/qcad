// ***** AUTOGENERATED CODE, DO NOT EDIT *****
    ...
    // methods:
            ...
            REcmaHelper::registerFunction(&engine, proto, cloneToFaceEntity, "cloneToFaceEntity");
    ...
    RFaceEntity::
       init();
         ...
         QScriptValue
        REcmaSharedPointerFaceEntity::getRtti
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaSharedPointerFaceEntity::getRtti", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaSharedPointerFaceEntity::getRtti";
            //QCoreApplication::processEvents();
    ...
    RS::EntityType cppResult =
       ...
       getRtti();
        // return type: RS::EntityType
            ...
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RFaceEntity.getRtti().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaSharedPointerFaceEntity::getRtti", context, engine);
            return result;
        }
         QScriptValue
    ...
    QSharedPointer < RObject > cppResult =
        ...
        // return type: QSharedPointer < RObject >
         ...
         QScriptValue
        REcmaSharedPointerFaceEntity::cloneToFaceEntity
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaSharedPointerFaceEntity::cloneToFaceEntity", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaSharedPointerFaceEntity::cloneToFaceEntity";
            //QCoreApplication::processEvents();
            ...
            QScriptValue result = engine->undefinedValue();
                    ...
                    // public function: can be called from ECMA wrapper of ECMA shell:
                    RFaceEntity* self = 
                        getSelf("cloneToFaceEntity", context);
    ...
    // call C++ function:
    // return type 'QSharedPointer < RFaceEntity >'
    QSharedPointer < RFaceEntity > cppResult =
        
               self->cloneToFaceEntity();
        // return type: QSharedPointer < RFaceEntity >
            ...
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RFaceEntity.cloneToFaceEntity().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaSharedPointerFaceEntity::cloneToFaceEntity", context, engine);
            return result;
        }
         QScriptValue
    ...
    // prepare arguments:
                    ...
                    if( ap0 == NULL ){
                           ...
                           return REcmaHelper::throwError("RFaceEntity: Argument 0 is not of type RExporter* or QSharedPointer<RExporter>.",
                               context);
                    }
                    RExporter& a0 = *ap0;
