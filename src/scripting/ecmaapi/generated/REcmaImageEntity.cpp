// ***** AUTOGENERATED CODE, DO NOT EDIT *****
    ...
    // methods:
            ...
            REcmaHelper::registerFunction(&engine, proto, cloneToImageEntity, "cloneToImageEntity");
    ...
    // prepare arguments:
                    ...
                    if( ap0 == NULL ){
                           ...
                           return REcmaHelper::throwError("RImageEntity: Argument 0 is not of type RImageEntity* or QSharedPointer<RImageEntity>.",
                               context);
                    }
                    RImageEntity& a0 = *ap0;
    ...
    RImageEntity::
       init();
         ...
         QScriptValue
        REcmaImageEntity::getRtti
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaImageEntity::getRtti", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaImageEntity::getRtti";
            //QCoreApplication::processEvents();
    ...
    RS::EntityType cppResult =
       ...
       getRtti();
        // return type: RS::EntityType
            ...
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RImageEntity.getRtti().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaImageEntity::getRtti", context, engine);
            return result;
        }
         QScriptValue
    ...
    QSharedPointer < RObject > cppResult =
        ...
        // return type: QSharedPointer < RObject >
         ...
         QScriptValue
        REcmaImageEntity::cloneToImageEntity
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaImageEntity::cloneToImageEntity", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaImageEntity::cloneToImageEntity";
            //QCoreApplication::processEvents();
            ...
            QScriptValue result = engine->undefinedValue();
                    ...
                    // public function: can be called from ECMA wrapper of ECMA shell:
                    RImageEntity* self = 
                        getSelf("cloneToImageEntity", context);
    ...
    // call C++ function:
    // return type 'QSharedPointer < RImageEntity >'
    QSharedPointer < RImageEntity > cppResult =
        
               self->cloneToImageEntity();
        // return type: QSharedPointer < RImageEntity >
            ...
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RImageEntity.cloneToImageEntity().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaImageEntity::cloneToImageEntity", context, engine);
            return result;
        }
         QScriptValue
    ...
    // prepare arguments:
                    ...
                    if( ap0 == NULL ){
                           ...
                           return REcmaHelper::throwError("RImageEntity: Argument 0 is not of type RExporter* or QSharedPointer<RExporter>.",
                               context);
                    }
                    RExporter& a0 = *ap0;
