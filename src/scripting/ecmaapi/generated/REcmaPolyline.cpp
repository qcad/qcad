// ***** AUTOGENERATED CODE, DO NOT EDIT *****
    ...
    bool cppResult =
        ...
        // return type: bool
         ...
         QScriptValue
        REcmaPolyline::isOnShape
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaPolyline::isOnShape", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaPolyline::isOnShape";
            //QCoreApplication::processEvents();
    ...
    a2);
        // return type: bool
            ...
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RPolyline.isOnShape().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaPolyline::isOnShape", context, engine);
            return result;
        }
         QScriptValue
