// ***** AUTOGENERATED CODE, DO NOT EDIT *****
    ...
    // methods:
            ...
            REcmaHelper::registerFunction(&engine, proto, cloneToSplineEntity, "cloneToSplineEntity");
    ...
    // prepare arguments:
                    ...
                    if( ap0 == NULL ){
                           ...
                           return REcmaHelper::throwError("RSplineEntity: Argument 0 is not of type RSplineEntity* or QSharedPointer<RSplineEntity>.",
                               context);
                    }
    ...
    RSplineEntity::
       init();
         ...
         QScriptValue
        REcmaSharedPointerSplineEntity::getRtti
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaSharedPointerSplineEntity::getRtti", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaSharedPointerSplineEntity::getRtti";
            //QCoreApplication::processEvents();
    ...
    RS::EntityType cppResult =
       ...
       getRtti();
        // return type: RS::EntityType
            ...
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RSplineEntity.getRtti().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaSharedPointerSplineEntity::getRtti", context, engine);
            return result;
        }
         QScriptValue
    ...
    QSharedPointer < RObject > cppResult =
        ...
        // return type: QSharedPointer < RObject >
         ...
         QScriptValue
        REcmaSharedPointerSplineEntity::cloneToSplineEntity
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaSharedPointerSplineEntity::cloneToSplineEntity", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaSharedPointerSplineEntity::cloneToSplineEntity";
            //QCoreApplication::processEvents();
            ...
            QScriptValue result = engine->undefinedValue();
                    ...
                    // public function: can be called from ECMA wrapper of ECMA shell:
                    RSplineEntity* self = 
                        getSelf("cloneToSplineEntity", context);
    ...
    // call C++ function:
    // return type 'QSharedPointer < RSplineEntity >'
    QSharedPointer < RSplineEntity > cppResult =
        
               self->cloneToSplineEntity();
        // return type: QSharedPointer < RSplineEntity >
            ...
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RSplineEntity.cloneToSplineEntity().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaSharedPointerSplineEntity::cloneToSplineEntity", context, engine);
            return result;
        }
         QScriptValue
    ...
    // prepare arguments:
                    ...
                    if( ap0 == NULL ){
                           ...
                           return REcmaHelper::throwError("RSplineEntity: Argument 0 is not of type RExporter* or QSharedPointer<RExporter>.",
                               context);
                    }
                    RExporter& a0 = *ap0;
