    ...
    // type: RVector &, copyable: true
      ...
      double REcmaShellFileExporterAdapter::getPatternOffset(
                double length, const RLinetypePattern & pattern
            ) {
                QScriptEngine* engine = __qtscript_self.engine();
                //REcmaHelper::shellFunctionStart("REcmaShellFileExporterAdapter::getPatternOffset", engine);
                QScriptValue _q_function = __qtscript_self.property("getPatternOffset");
                ...
                if (!_q_function.isFunction() || 
                    ...
                    //QString cppSig = "RFileExporterAdapter::getPatternOffset";
                        ...
                        //}
                        double ret =
                        RFileExporterAdapter::getPatternOffset(
                            length, pattern
                        );
                        ...
                        //REcmaHelper::shellFunctionEnd("REcmaShellFileExporterAdapter::getPatternOffset", engine);
