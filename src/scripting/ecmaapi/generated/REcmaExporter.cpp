// ***** AUTOGENERATED CODE, DO NOT EDIT *****
        ...
        // includes for base ecma wrapper classes
         void REcmaExporter::init(QScriptEngine& engine, QScriptValue* proto 
    ...
    if( protoCreated ){
     ...
     QScriptValue REcmaExporter::create(QScriptContext* context, QScriptEngine* engine) 
    ...
    a1);
         ...
         QScriptValue
        REcmaExporter::getPatternFactor
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaExporter::getPatternFactor", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaExporter::getPatternFactor";
            //QCoreApplication::processEvents();
    ...
    double cppResult =
        ...
        // return type: double
            ...
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RExporter.getPatternFactor().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaExporter::getPatternFactor", context, engine);
            return result;
        }
         QScriptValue
