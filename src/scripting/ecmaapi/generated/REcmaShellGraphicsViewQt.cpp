    ...
    // type: QDropEvent *, copyable: false
      ...
      bool REcmaShellGraphicsViewQt::focusNextPrevChild(
                bool next
            ) {
                QScriptEngine* engine = __qtscript_self.engine();
                //REcmaHelper::shellFunctionStart("REcmaShellGraphicsViewQt::focusNextPrevChild", engine);
                ...
                if (!_q_function.isFunction() || 
                    ...
                    //QString cppSig = "RGraphicsViewQt::focusNextPrevChild";
                        ...
                        //}
                        bool ret =
                        RGraphicsViewQt::focusNextPrevChild(
                            next
                        );
                        ...
                        //REcmaHelper::shellFunctionEnd("REcmaShellGraphicsViewQt::focusNextPrevChild", engine);
                    ...
                    _q_function.setData(QScriptValue(engine, uint(prev | 0x0000B000)));
                        ...
                        // temporary make protected function scriptable, only from the context of this function call:
                        QScriptValue proto = engine->defaultPrototype(qMetaTypeId<RGraphicsViewQt*>());
                        REcmaHelper::registerFunction(engine, &proto, focusNextPrevChild, "focusNextPrevChild");
                        bool res;
    ...
    // return type 'void'
         ...
         QScriptValue
        REcmaShellGraphicsViewQt::focusNextPrevChild
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaShellGraphicsViewQt::focusNextPrevChild", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaShellGraphicsViewQt::focusNextPrevChild";
            //QCoreApplication::processEvents();
    ...
    bool cppResult =
               ...
               self->RGraphicsViewQt::focusNextPrevChild(a0);
        // return type: bool
                // standard Type
                result = QScriptValue(cppResult);
            ...
            {
               return REcmaHelper::throwError("Wrong number/types of arguments for RGraphicsViewQt.focusNextPrevChild().",
                   context);
            }
            //REcmaHelper::functionEnd("REcmaShellGraphicsViewQt::focusNextPrevChild", context, engine);
            return result;
        }
