// ***** AUTOGENERATED CODE, DO NOT EDIT *****
    ...
    ;static RRestrictHorizontal* getSelf(const QString& fName, QScriptContext* context)
    ;static RRestrictHorizontal* getSelfShell(const QString& fName, QScriptContext* context)
    ;};
    #endif
