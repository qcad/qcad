    ...
    ;static RDxfImporterFactory* getSelf(const QString& fName, QScriptContext* context)
    ;static RDxfImporterFactory* getSelfShell(const QString& fName, QScriptContext* context)
    ;};
    #endif
