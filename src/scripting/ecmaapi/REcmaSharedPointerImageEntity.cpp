    ...
    // ***** AUTOGENERATED CODE, DO NOT EDIT *****
        ...
        // includes for base ecma wrapper classes
                 ...
                 void REcmaSharedPointerImageEntity::init(QScriptEngine& engine, QScriptValue* proto 
    ...
    if( protoCreated ){
     ...
     QScriptValue REcmaSharedPointerImageEntity::create(QScriptContext* context, QScriptEngine* engine) 
    ...
    RImageEntity * cppResult =
        ...
        // return type: RImageEntity *
         ...
         QScriptValue
        REcmaSharedPointerImageEntity::getType
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaSharedPointerImageEntity::getType", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaSharedPointerImageEntity::getType";
            //QCoreApplication::processEvents();
    ...
    RS::EntityType cppResult =
        ...
        // return type: RS::EntityType
            ...
            //REcmaHelper::functionEnd("REcmaSharedPointerImageEntity::getType", context, engine);
            return result;
        }
         QScriptValue
