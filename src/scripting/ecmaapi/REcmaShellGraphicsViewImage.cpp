    ...
    // type: RGraphicsView::ColorMode, copyable: true
      ...
      void REcmaShellGraphicsViewImage::setDraftMode(
                bool on
            ) {
                QScriptEngine* engine = __qtscript_self.engine();
                //REcmaHelper::shellFunctionStart("REcmaShellGraphicsViewImage::setDraftMode", engine);
                ...
                if (!_q_function.isFunction() || 
                    ...
                    //QString cppSig = "RGraphicsViewImage::setDraftMode";
                        ...
                        //if (cppSig!="RGraphicsViewQt::event") {
                            _q_function.setData(QScriptValue(engine, prev & 0xFFFF0000));
                        //}
                        RGraphicsViewImage::setDraftMode(
                            on
                        );
                        ...
                        //REcmaHelper::shellFunctionEnd("REcmaShellGraphicsViewImage::setDraftMode", engine);
    ...
    // type: bool, copyable: true
      ...
      bool REcmaShellGraphicsViewImage::getDraftMode(
                
            ) {
                QScriptEngine* engine = __qtscript_self.engine();
                //REcmaHelper::shellFunctionStart("REcmaShellGraphicsViewImage::getDraftMode", engine);
                ...
                if (!_q_function.isFunction() || 
                    ...
                    //QString cppSig = "RGraphicsViewImage::getDraftMode";
                        ...
                        //}
                        bool ret =
                        RGraphicsViewImage::getDraftMode(
                        ...
                        //REcmaHelper::shellFunctionEnd("REcmaShellGraphicsViewImage::getDraftMode", engine);
