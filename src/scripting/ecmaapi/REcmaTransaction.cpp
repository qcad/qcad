    ...
    // prepare arguments:
                    ...
                    if (a5==NULL && 
                        ...
                        return REcmaHelper::throwError("RTransaction: Argument 5 is not of type RTransaction *RTransaction *.", context);                    
                    }
    ...
    // prepare arguments:
                    ...
                    if (a3==NULL && 
                        ...
                        return REcmaHelper::throwError("RTransaction: Argument 3 is not of type RTransaction *RTransaction *.", context);                    
                    }
