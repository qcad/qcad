...
public:
    ...
    virtual void updateImportListener(RDocumentInterface* documentInterface) {
        emit importFinished(documentInterface);
    }

signals:
    void importFinished(RDocumentInterface* documentInterface);
};
