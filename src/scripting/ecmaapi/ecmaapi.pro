...
HEADERS += adapters/RBlockListenerAdapter.h
HEADERS += adapters/RCoordinateListenerAdapter.h
HEADERS += adapters/RFileExporterAdapter.h
HEADERS += adapters/RFileExporterFactoryAdapter.h
HEADERS += adapters/RFileImporterAdapter.h
HEADERS += adapters/RFileImporterFactoryAdapter.h
HEADERS += adapters/RFocusListenerAdapter.h
HEADERS += adapters/RFontDatabase.h
HEADERS += adapters/RLayerListenerAdapter.h
HEADERS += adapters/RPenListenerAdapter.h
HEADERS += adapters/RSelectionListenerAdapter.h
HEADERS += adapters/RSpatialIndexVisitorAdapter.h
HEADERS += adapters/RViewFocusListenerAdapter.h
HEADERS += adapters/RViewListenerAdapter.h
