    ...
    if( protoCreated ){
     ...
     QScriptValue REcmaEllipse::create(QScriptContext* context, QScriptEngine* engine) 
    ...
    REllipse cppResult =
       ...
       createInscribed(a0);
        // return type: REllipse
         ...
         QScriptValue
        REcmaEllipse::createFromEquation
        (QScriptContext* context, QScriptEngine* engine) 
        
        {
            //REcmaHelper::functionStart("REcmaEllipse::createFromEquation", context, engine);
            //qDebug() << "ECMAScript WRAPPER: REcmaEllipse::createFromEquation";
            //QCoreApplication::processEvents();
    ...
    a2);
        // return type: REllipse
            ...
            //REcmaHelper::functionEnd("REcmaEllipse::createFromEquation", context, engine);
            return result;
        }
         QScriptValue
        REcmaEllipse::clone
    ...
    QString result;
            ...
            result = QString("REllipse(0x%1)").arg((unsigned long int)self, 0, 16);
